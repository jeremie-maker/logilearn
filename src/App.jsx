...
const CH10 = {id:"c10",num:10,title:"Les modes de transport",icon:"🚛",color:"#37474F",textColor:"#fff",
 content:[
  ...
  {T:"hl",bg:"#e3f2fd",b:"#1565C0",ti:"Chiffres clés",x:"5'000 km de rails (réseau le plus dense d'Europe)\n3'000 km exploités par les CFF\n671 tunnels (dont 250 CFF) / 6'000 ponts ferroviaires\nCFF Cargo : plus grand prestataire de fret ferroviaire en Suisse\nBLS Cargo (créé en 2001) : transit alpin via Lötschberg, Simplon, Gothard\nNLFA : Nouvelles Lignes Ferroviaires à travers les Alpes (tunnels de base Gothard et Lötschberg)"},
