...
const CH1 = {id:"c1",num:1,mod:"C",title:"Les systèmes de distribution",icon:"🚚",color:"#1565C0",textColor:"#fff",
 content:[
...
const CH2 = {id:"c2",num:2,mod:"C",title:"Le marché des services de distribution",icon:"🏢",color:"#00695C",textColor:"#fff",
 content:[
...
const CH3 = {id:"c3",num:3,mod:"C",title:"Les emballages",icon:"📦",color:"#E65100",textColor:"#fff",
 content:[
...
const CH4 = {id:"c4",num:4,mod:"C",title:"Les normes d'emballages",icon:"📐",color:"#4527A0",textColor:"#fff",
 content:[
...
const CH5 = {id:"c5",num:5,mod:"C",title:"Le marquage des emballages",icon:"🏷️",color:"#283593",textColor:"#fff",
 content:[
...
const CH6 = {id:"c6",num:6,mod:"C",title:"L'expédition",icon:"✉️",color:"#1B4F8A",textColor:"#fff",
 content:[
...
const CH7 = {id:"c7",num:7,mod:"C",title:"L'adressage",icon:"📍",color:"#558B2F",textColor:"#fff",
 content:[
...
const CH8 = {id:"c8",num:8,mod:"C",title:"Track and Trace",icon:"📡",color:"#00838F",textColor:"#fff",
 content:[
...
const CH9 = {id:"c9",num:9,mod:"C",title:"La remise et la distribution",icon:"🚪",color:"#AD1457",textColor:"#fff",
 content:[
...
const CH10 = {id:"c10",num:10,mod:"C",title:"Les modes de transport",icon:"🚛",color:"#37474F",textColor:"#fff",
 content:[
...
const CH11 = {id:"c11",num:11,mod:"C",title:"L'arrimage des marchandises sur palettes",icon:"🔒",color:"#6D4C41",textColor:"#fff",
 content:[
...
const CH12 = {id:"c12",num:12,mod:"C",title:"Le chargement de marchandises",icon:"⚖️",color:"#1B5E20",textColor:"#fff",
 content:[
...
const CH13 = {id:"c13",num:13,mod:"C",title:"La surveillance du transport",icon:"📊",color:"#4A148C",textColor:"#fff",
 content:[
...
const CH14 = {id:"c14",num:14,mod:"C",title:"La planification des transports",icon:"🗺️",color:"#0277BD",textColor:"#fff",
 content:[
...
const CHA7 = {id:"ca7",num:7,mod:"A",title:"Les engins de transport",icon:"🟫",color:"#1565C0",textColor:"#fff",
 content:[
  {T:"intro",x:"Les engins de transport — au premier rang desquels les palettes — sont les supports de charge fondamentaux de la logistique. Leur standardisation et leur système d'échange (pools) permettent une circulation efficace des marchandises en Suisse et en Europe."},
  {T:"section",x:"Les 3 standards mondiaux de palettes"},
  {T:"img",src:"/images/na_epal.png",alt:"Palette EPAL — structure, blocs, planches et marquages"},
  {T:"hl",bg:"#e3f2fd",b:"#1565C0",ti:"Dimensions selon les continents",x:"• Europe : EUR 1 (120×80 cm) / EUR 2 (100×120 cm)\n• Amérique du Nord : 48×40 pouces (122×101,6 cm)\n• Asie : 110×110 cm"},
  {T:"text",x:"L'Euro-palette suisse a été fondée en 1952 par les CFF. L'European Pallet Pool (EPP), fondé en 1962, est une union des chemins de fer européens visant à simplifier les transports nationaux et internationaux au moyen de palettes échangeables."},
  {T:"section",x:"Les charges maximales d'une Euro-palette"},
  {T:"list",items:["1000 kg lorsque la charge est mal répartie","1500 kg lorsque la charge est répartie de manière uniforme","2000 kg lorsque la charge est compacte et uniforme sur toute la palette"]},
  {T:"section",x:"Les critères d'échange (EPAL)"},
  {T:"text",x:"Le pool européen a établi des normes obligatoires. Une palette présentant des dégâts n'est pas échangeable et est refusée."},
  {T:"hl",bg:"#fef2f2",b:"#C62828",ti:"Une palette n'est PAS échangeable si :",x:"• Planche manquante\n• Planche avec cassure\n• Planche laissant apparaître les clous\n• Plot manquant ou fendu\n• Sigle CFF ou sigle EUR manquant\n• Mauvais état général\n• Trop sale"},
  {T:"section",x:"Les pools d'engins échangeables"},
  {T:"hl",bg:"#fff8e1",b:"#f59e0b",ti:"Pool ouvert vs Pool fermé",x:"POOL OUVERT — chaque membre qui transmet un engin reçoit un équivalent :\n• Échange standard (pièce contre pièce)\n• Échange contre bon\n• Compte courant (entrées/sorties enregistrées)\n\nPOOL FERMÉ — les palettes sont LOUÉES (ex. CHEP, palettes bleues) :\n• Pas d'échange de support\n• Supports transmis à un centre de rassemblement"},
  {T:"section",x:"Les supports de charge spéciaux"},
  {T:"list",items:["Palette en tôle d'acier : charge jusqu'à 2 tonnes","Palette en matière synthétique : zones humides, industrie chimique, agroalimentaire","Palette à fûts : transport sûr de fûts couchés","Palette-réservoir / varitainer : liquides ou matières dangereuses","Box métallique : vrac, collecte de déchets, recyclage","Box en bois : transport et stockage de fruits et légumes","Conteneurs à roues (roolcontainers) : évitent les coûts d'emballage sur courtes distances"]},
  {T:"section",x:"Où se font les échanges ?"},
  {T:"list",items:["En Suisse","À l'étranger avec les filiales CFF Cargo","Avec les pays appartenant à l'European Pallet (Allemagne, Croatie, Autriche, Suisse...)"]},
  {T:"section",x:"Les cadres et couvercles"},
  {T:"text",x:"Les cadres sont uniquement échangés en Suisse et en Autriche. Ils ne sont pas échangeables si : signes distinctifs non conformes, parois enfoncées ou fendues, parois intérieures très sales, ou mauvais état général."},
  {T:"section",x:"Les marquages de qualité d'une palette EPAL"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Normes de qualité à vérifier",x:"• Marque EPAL (European Pallet Association)\n• Marquage d'un réseau ferré européen\n• Marque du pool européen (EUR)\n• Plan de cloutage standardisé\n• Planche de rive\n• Aucune trace de moisissure\n• Agrafe de contrôle qualité avec marque EPAL\n• En cas de réparation : clou de réparation avec marque EPAL"},
  {T:"gloss",items:[
    {term:"Euro-palette (EUR)",def:"Support de chargement standardisé 120×80 cm, le plus utilisé en Europe. Fondée en Suisse en 1952 par les CFF."},
    {term:"EPAL",def:"European Pallet Association — marque de qualité garantissant qu'une palette respecte les normes d'échange."},
    {term:"EPP",def:"European Pallet Pool, fondé en 1962 : union des chemins de fer européens pour les palettes échangeables."},
    {term:"Pool ouvert",def:"Système où chaque engin transmis est compensé par un engin équivalent (échange standard, contre bon ou compte courant)."},
    {term:"Pool fermé",def:"Système où les palettes sont louées (ex. CHEP) sans échange de support."}
  ]}],
 questions:[
  {q:"Quelles sont les dimensions de l'Euro-palette EUR 1 ?",options:["100×120 cm","120×80 cm","110×110 cm","48×40 pouces"],answer:1},
  {q:"En quelle année l'Euro-palette suisse a-t-elle été fondée et par qui ?",options:["1962 par l'UE","1952 par les CFF","1944 par la Poste","1980 par GS1"],answer:1},
  {q:"Quelle est la charge maximale d'une Euro-palette avec une charge compacte et uniforme ?",options:["1000 kg","1500 kg","2000 kg","2500 kg"],answer:2},
  {q:"Quels défauts rendent une palette NON échangeable ? (plusieurs réponses)",options:["Planche manquante","Plot fendu","Sigle EUR manquant","Légèrement poussiéreuse mais intacte"],answers:[0,1,2],multi:true},
  {q:"Dans un pool fermé, les palettes sont :",options:["Échangées pièce contre pièce","Louées (ex. CHEP)","Données gratuitement","Détruites après usage"],answer:1},
  {q:"Le compte courant est une forme d'échange du :",options:["Pool fermé","Pool ouvert","Pool mixte","Pool international"],answer:1},
  {q:"Quel support spécial convient au transport de liquides ou matières dangereuses ?",options:["Box en bois","Palette-réservoir / varitainer","Conteneur à roues","Palette en copeaux"],answer:1},
  {q:"L'European Pallet Pool (EPP) a été fondé en :",options:["1952","1962","1944","1972"],answer:1}
 ]};

const CHA8 = {id:"ca8",num:8,mod:"A",title:"Le concept transporter",icon:"🚚",color:"#1565C0",textColor:"#fff",
 content:[
  {T:"intro",x:"Le concept transporter se résume au transport d'objets avec la moindre dépense d'énergie possible. En logistique, « transporter » désigne le mouvement suivi par les marchandises au sein de l'entreprise."},
  {T:"section",x:"Le choix du moyen de transport"},
  {T:"img",src:"/images/na_transport.png",alt:"Classification des moyens de transport (continu / discontinu)"},
  {T:"list",items:["Type de marchandise","Masse et dimensions","Quantités","Longueur du trajet","Rationalisation (optimisation des coûts)"]},
  {T:"section",x:"Critères de subdivision"},
  {T:"hl",bg:"#e3f2fd",b:"#1565C0",ti:"Deux critères supplémentaires",x:"• Mode de guidage : sur rail / sans rail\n• Nature des marchandises : emballé / en vrac / liquide"},
  {T:"section",x:"Moyens de transport discontinus et continus"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Classification des moyens",x:"DISCONTINUS AU SOL : chariots (diable), transpalettes, chariots élévateurs, préparateurs de commande, systèmes filoguidés, transstockeurs\n\nDISCONTINUS AÉRIENS : ponts roulants, portiques, grues pivotantes/murales, palans, ascenseurs\n\nCONTINUS : convoyeurs à bande, à rouleaux, à chaîne, aériens, à étage (pater-noster), spéciaux (toboggans)"},
  {T:"section",x:"Le chariot élévateur à contrepoids"},
  {T:"img",src:"/images/na_chariot.png",alt:"Diagramme de charge d'un chariot élévateur — loi du levier"},
  {T:"text",x:"Le chariot élévateur lève les charges en se basant sur la loi du levier. La capacité de levage peut être augmentée de trois manières : augmentation du poids du chariot, allongement du bras de levier du contrepoids, ou raccourcissement du bras de levier de charge."},
  {T:"img",src:"/images/na_levier.png",alt:"La loi des leviers : point d'appui, force, bras du couple, moment"},
  {T:"img",src:"/images/na_calcul.png",alt:"Exemple de calcul : moment gauche (0,4 m × 200 N) = moment droite (0,8 m × 100 N) = 80 Nm — levier en équilibre"},
  {T:"hl",bg:"#fff8e1",b:"#f59e0b",ti:"La loi des leviers",x:"• Point d'appui (P) : point sur lequel repose le levier\n• Force (F) : force agissant sur le bras de levier\n• Bras du couple (a) : distance entre le point d'appui et le point d'application de la force\n• Moment (M) : produit de la force par la longueur du bras du couple, exprimé en Nm (newton-mètre)"},
  {T:"section",x:"Le diagramme de capacité de charge"},
  {T:"img",src:"/images/na_capacite.png",alt:"Capacité de charge selon la distance du centre de gravité"},
  {T:"text",x:"Ce diagramme indique la charge maximale admissible pour différentes distances du centre de gravité. Point essentiel : la capacité de charge DIMINUE quand la hauteur de levage augmente."},
  {T:"gloss",items:[
    {term:"Concept transporter",def:"Transport d'objets avec la moindre dépense d'énergie possible ; mouvement des marchandises dans l'entreprise."},
    {term:"Moyen continu",def:"Installation transportant en flux ininterrompu (convoyeur à bande, à rouleaux, pater-noster)."},
    {term:"Moyen discontinu",def:"Engin transportant par cycles séparés (chariot élévateur, transpalette, grue)."},
    {term:"Loi du levier",def:"Principe physique : Moment = Force × longueur du bras. Base du fonctionnement du chariot élévateur."},
    {term:"Centre de gravité",def:"Point d'application du poids d'une charge. Plus il est éloigné du mât, plus la capacité du chariot diminue."}
  ]}],
 questions:[
  {q:"Le concept transporter se définit comme :",options:["Transporter le plus vite possible","Transport d'objets avec la moindre dépense d'énergie","Transporter uniquement par la route","Transporter sans emballage"],answer:1},
  {q:"Quels critères déterminent le choix du moyen de transport ? (plusieurs réponses)",options:["Type de marchandise","Masse et dimensions","Longueur du trajet","Couleur de l'emballage"],answers:[0,1,2],multi:true},
  {q:"Le pater-noster est un convoyeur :",options:["Discontinu au sol","Continu à étage","Aérien discontinu","Sur rail"],answer:1},
  {q:"Le chariot élévateur lève les charges en se basant sur :",options:["La force hydraulique seule","La loi du levier","L'aimantation","La pression atmosphérique"],answer:1},
  {q:"Comment augmenter la capacité de levage d'un chariot ? (plusieurs réponses)",options:["Augmenter le poids du chariot","Allonger le bras de levier du contrepoids","Raccourcir le bras de levier de charge","Réduire la taille des roues"],answers:[0,1,2],multi:true},
  {q:"Le moment d'un levier s'exprime en :",options:["Kilogrammes (kg)","Newton-mètre (Nm)","Watts (W)","Litres (l)"],answer:1},
  {q:"Quand la hauteur de levage augmente, la capacité de charge :",options:["Augmente","Diminue","Reste identique","Double"],answer:1},
  {q:"Un transpalette est un moyen de transport :",options:["Continu","Discontinu au sol","Aérien","Sur rail"],answer:1}
 ]};

const CHA9 = {id:"ca9",num:9,mod:"A",title:"L'identification",icon:"🔖",color:"#1565C0",textColor:"#fff",
 content:[
  {T:"intro",x:"L'identification des marchandises repose sur des codes standardisés (codes-barres linéaires, codes 2D, RFID) qui permettent de suivre et gérer les produits depuis la production jusqu'à la vente, à l'échelle mondiale."},
  {T:"section",x:"Le code EAN 13 / GTIN"},
  {T:"text",x:"Le code-barres figure sur chaque produit en magasin. Il s'agit d'un code EAN de type GTIN (Global Trade Item Number). EAN = European Article Numbering ; 13 = nombre de chiffres. Chaque numéro n'est attribué qu'une seule fois au niveau mondial. En Suisse : GS1 Suisse."},
  {T:"hl",bg:"#e3f2fd",b:"#1565C0",ti:"Les préfixes pays du code EAN 13",x:"• 400-440 : Allemagne\n• 76 : Suisse et Liechtenstein\n• 90-91 : Autriche\n• 00-13 : USA\n• 977 : magazines (échelle mondiale)\n• 978-979 : livres (échelle mondiale)"},
  {T:"text",x:"L'ISBN (International Standard Book Number) était constitué de 10 chiffres ; il est désormais intégré dans le système EAN 13. Les préfixes internes 22 à 29 sont utilisés pour les articles vendus au poids dans les produits frais."},
  {T:"section",x:"Le code EAN 128 et le SSCC"},
  {T:"text",x:"L'EAN 128 est une étiquette de transport apposée sur les palettes, cartons et livraisons. L'ajout du code SSCC (Serial Shipping Container Code) permet de suivre l'intégralité du trajet (Tracking & Tracing) : il sert de numéro de référence unique mondial pour une unité de transport."},
  {T:"section",x:"Les codes à deux dimensions (2D)"},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Les principaux codes 2D",x:"• Aztec : développé pour l'industrie des transports, présent sur les billets CFF\n• QR (Quick Response) : créé par Denso Wave en 1994 pour Toyota — utilisé en expo, musées, monuments\n• DataMatrix : marquage direct permanent au laser, gestion de documents, envois postaux"},
  {T:"section",x:"Le code RFID"},
  {T:"text",x:"RFID = Radio Frequency Identification : une puce d'identification est intégrée dans l'étiquette. Applications : chronométrage de manifestations sportives, gestion de stock, vêtements intelligents, protection antivol, traçabilité des meules de fromage."},
  {T:"section",x:"L'emplacement des étiquettes"},
  {T:"img",src:"/images/na_etiquette.png",alt:"Emplacement des étiquettes sur palette : 450 mm du sol, 50 mm des bords"},
  {T:"text",x:"Les palettes sont étiquetées sur au moins deux côtés, au niveau des angles. Le symbole le plus bas doit être situé 450 mm (45 cm) au-dessus du sol. La distance par rapport à l'arête extérieure ne doit pas être inférieure à 50 mm (5 cm)."},
  {T:"gloss",items:[
    {term:"EAN 13 / GTIN",def:"Code-barres standard à 13 chiffres identifiant un article de façon unique au niveau mondial. GTIN = Global Trade Item Number."},
    {term:"GS1 Suisse",def:"Organisation suisse qui attribue les numéros EAN/GTIN aux entreprises."},
    {term:"EAN 128 / SSCC",def:"Étiquette de transport ; le SSCC (Serial Shipping Container Code) permet le suivi unique d'une unité de transport."},
    {term:"Tracking & Tracing",def:"Suivi et traçabilité : renseigne sur l'endroit où se trouve la marchandise à un moment donné."},
    {term:"RFID",def:"Radio Frequency Identification : puce électronique dans l'étiquette permettant une identification sans contact."},
    {term:"Code QR",def:"Quick Response — code 2D créé par Denso Wave (1994) pour Toyota, lisible rapidement."}
  ]}],
 questions:[
  {q:"Que signifie l'acronyme EAN ?",options:["European Article Numbering","Electronic Article Network","European Automatic Number","Easy Article Naming"],answer:0},
  {q:"Quel préfixe EAN 13 correspond à la Suisse et au Liechtenstein ?",options:["400-440","76","90-91","00-13"],answer:1},
  {q:"Que permet l'ajout du code SSCC à une étiquette EAN 128 ?",options:["Réduire le prix","Suivre l'intégralité du trajet (Tracking & Tracing)","Changer la couleur","Augmenter le poids"],answer:1},
  {q:"Quels sont des codes à deux dimensions (2D) ? (plusieurs réponses)",options:["Aztec","QR","DataMatrix","EAN 13"],answers:[0,1,2],multi:true},
  {q:"Le code QR a été créé en 1994 par :",options:["Toyota directement","Denso Wave","GS1","Les CFF"],answer:1},
  {q:"Que signifie RFID ?",options:["Rapid Form Identification","Radio Frequency Identification","Remote File ID","Radio Format Index"],answer:1},
  {q:"À quelle hauteur du sol doit se situer le symbole le plus bas d'une étiquette de palette ?",options:["20 cm","45 cm (450 mm)","60 cm","1 mètre"],answer:1},
  {q:"L'ISBN est utilisé pour identifier :",options:["Les médicaments","Les livres","Les aliments","Les vêtements"],answer:1}
 ]};
...
const MODULE_A_RAND_POOL = [
  ...
  ...CHA7.questions.map(q=>({...q,_ch:"CHA7",_chTitle:"Engins de transport",_chColor:CHA7.color,_chTextColor:CHA7.textColor})),
  ...CHA8.questions.map(q=>({...q,_ch:"CHA8",_chTitle:"Concept transporter",_chColor:CHA8.color,_chTextColor:CHA8.textColor})),
  ...CHA9.questions.map(q=>({...q,_ch:"CHA9",_chTitle:"L'identification",_chColor:CHA9.color,_chTextColor:CHA9.textColor})),
];

const MODULE_A = [CHA1,CHA2,CHA3,CHA4,CHA5,CHA6,CHA7,CHA8,CHA9];
...
const CHB7 = {id:"cb7",num:7,mod:"B",title:"Les systèmes de stockage",icon:"🏗️",color:"#2E7D32",textColor:"#fff",
 content:[
  {T:"intro",x:"Les systèmes de stockage sont des installations complexes composées de rayonnages et de systèmes de manutention, souvent construits avant le bâtiment. Ils sont couplés au système de gestion des stocks ou au logiciel ERP."},
  {T:"section",x:"Les entrepôts classés par hauteur"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Trois catégories de hauteur",x:"• Faible hauteur : jusqu'à 7 m — chariots classiques, forme la plus répandue chez les PME, peu coûteux, montable dans un bâtiment existant\n• Moyenne hauteur : jusqu'à 15 m — chariots à grande hauteur, investissement considérable, grands bâtiments\n• Grande hauteur : jusqu'à 45 m — intégrés à des systèmes complexes"},
  {T:"section",x:"Entrepôts mécanisés et automatisés"},
  {T:"text",x:"Entrepôts mécanisés : rayonnages de moyenne ou grande hauteur équipés de transtockeurs commandés par un conducteur, efficaces pour le prélèvement de petites quantités."},
  {T:"text",x:"Entrepôts automatisés : utilisés par les grands centres logistiques. Ils nécessitent le matériel (Hardware) et le logiciel (Software). Ces systèmes sont fermés et ne sont accessibles à l'homme qu'en cas de panne ou de maintenance."},
  {T:"section",x:"Les systèmes de stockage complexes"},
  {T:"list",items:["Systèmes de déchargement et de chargement","Installations de stockage statique et dynamique","Convoyeurs continus et discontinus","Postes de préparation de commande","Systèmes d'emballage"]},
  {T:"gloss",items:[
    {term:"Entrepôt de faible hauteur",def:"Jusqu'à 7 m, avec chariots classiques. Forme la plus répandue chez les PME."},
    {term:"Entrepôt de grande hauteur",def:"Jusqu'à 45 m, intégré à des systèmes de stockage complexes et automatisés."},
    {term:"Transtockeur",def:"Engin automatique se déplaçant dans les allées pour stocker et prélever les marchandises."},
    {term:"Entrepôt automatisé",def:"Système fermé piloté par logiciel (Software) et matériel (Hardware), inaccessible sauf panne/maintenance."},
    {term:"ERP",def:"Enterprise Resource Planning : logiciel de gestion intégrée couplé au système de stockage."}
  ]}],
 questions:[
  {q:"Quelle est la hauteur maximale d'un entrepôt de faible hauteur ?",options:["5 m","7 m","15 m","45 m"],answer:1},
  {q:"Un entrepôt de grande hauteur peut atteindre :",options:["15 m","25 m","45 m","60 m"],answer:2},
  {q:"Les entrepôts automatisés sont accessibles à l'homme :",options:["En permanence","Uniquement en cas de panne ou maintenance","Jamais","Une fois par jour"],answer:1},
  {q:"Que faut-il pour un entrepôt automatisé ? (plusieurs réponses)",options:["Le matériel (Hardware)","Le logiciel (Software)","Un conducteur permanent dans le système","Un système de commande"],answers:[0,1,3],multi:true},
  {q:"L'entrepôt de faible hauteur est surtout utilisé par :",options:["Les grands centres logistiques","Les PME","Les ports uniquement","Les aéroports"],answer:1},
  {q:"Un transtockeur dans un entrepôt mécanisé est commandé par :",options:["Un robot autonome","Un conducteur","Le client","Personne"],answer:1},
  {q:"Quelle est la hauteur d'un entrepôt de moyenne hauteur ?",options:["Jusqu'à 7 m","Jusqu'à 15 m","Jusqu'à 30 m","Jusqu'à 45 m"],answer:1},
  {q:"Un système de stockage complexe comprend : (plusieurs réponses)",options:["Convoyeurs continus et discontinus","Postes de préparation de commande","Systèmes d'emballage","Bureaux administratifs uniquement"],answers:[0,1,2],multi:true}
 ]};

const CHB8 = {id:"cb8",num:8,mod:"B",title:"La gestion des stocks",icon:"📊",color:"#2E7D32",textColor:"#fff",
 content:[
  {T:"intro",x:"La gestion des stocks englobe les termes techniques et les niveaux de stock permettant de suivre précisément les marchandises. Les fiches de stock font partie d'un système de gestion des stocks (SGS) ou d'un ERP."},
  {T:"section",x:"L'article et l'assortiment"},
  {T:"text",x:"Un article est un bien stocké dont toutes les pièces sont en tout point identiques. Un T-shirt de forme, taille ou couleur différente est un article différent. L'assortiment est l'ensemble des articles proposés par un point de vente ou un fabricant."},
  {T:"section",x:"Les niveaux de stock"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Les stocks à connaître",x:"• Stock de sécurité : réserve pour les coups durs\n• Stock minimum / point de commande : niveau déclenchant une nouvelle commande = (délai de livraison × conso journalière) + stock de sécurité\n• Stock disponible : unités immédiatement livrables\n• Stock total : nombre total de pièces dans l'entreprise"},
  {T:"section",x:"Stock réservé, en contrôle, bloqué"},
  {T:"list",items:["Stock réservé : réservé pour un client, encore présent mais plus disponible — diminue le stock disponible, pas le total","Stock en contrôle : marchandises à contrôler avant entrée — augmente le total mais pas le disponible","Stock bloqué : ne doit pas être utilisé ni livré — dans le total mais pas dans le disponible"]},
  {T:"section",x:"Prix d'achat et prix de vente"},
  {T:"text",x:"Le prix d'achat (ou prix d'acquisition) est le prix payé par le commerçant. L'article est revendu plus cher : c'est le prix de vente (PV). Les entrées de marchandises augmentent le stock, les sorties (prélèvements) le diminuent."},
  {T:"gloss",items:[
    {term:"Article",def:"Bien stocké dont toutes les pièces sont identiques. Une variante (taille, couleur) constitue un article différent."},
    {term:"Assortiment",def:"Ensemble des articles proposés par un point de vente ou un fabricant."},
    {term:"Stock de sécurité",def:"Réserve constituée pour faire face aux imprévus (retards, surconsommation)."},
    {term:"Point de commande",def:"Niveau de stock déclenchant une nouvelle commande = (délai × conso journalière) + stock de sécurité."},
    {term:"Stock disponible",def:"Nombre d'unités immédiatement livrables (total moins réservé, en contrôle et bloqué)."},
    {term:"Prix de vente (PV)",def:"Prix auquel l'article est revendu, supérieur au prix d'achat."}
  ]}],
 questions:[
  {q:"Qu'est-ce qu'un article en gestion des stocks ?",options:["N'importe quel objet de l'entrepôt","Un bien dont toutes les pièces sont identiques","Un assortiment complet","Une palette"],answer:1},
  {q:"Un T-shirt rouge taille M et un T-shirt bleu taille M sont :",options:["Le même article","Deux articles différents","Un assortiment","Le même stock"],answer:1},
  {q:"Comment calcule-t-on le point de commande ?",options:["Délai × prix","(Délai × conso journalière) + stock de sécurité","Stock total ÷ 2","Conso annuelle × prix"],answer:1},
  {q:"Le stock réservé pour un client :",options:["Augmente le stock total","Diminue le stock disponible mais pas le total","N'a aucun effet","Double le stock"],answer:1},
  {q:"Quels stocks ne sont PAS comptés dans le stock disponible ? (plusieurs réponses)",options:["Stock réservé","Stock en contrôle","Stock bloqué","Stock de sécurité utilisable"],answers:[0,1,2],multi:true},
  {q:"Le prix d'acquisition correspond au :",options:["Prix de vente au client","Prix payé par le commerçant","Prix avec marge","Prix TTC final"],answer:1},
  {q:"L'assortiment désigne :",options:["Un seul article","L'ensemble des articles proposés","Le stock de sécurité","Le point de commande"],answer:1},
  {q:"Les sorties de marchandises :",options:["Augmentent le stock","Diminuent le stock","N'ont aucun effet","Bloquent le stock"],answer:1}
 ]};

const CHB9 = {id:"cb9",num:9,mod:"B",title:"L'inventaire",icon:"📋",color:"#2E7D32",textColor:"#fff",
 content:[
  {T:"intro",x:"L'inventaire est un relevé précis et détaillé de tous les actifs (patrimoine) et passifs (dettes) d'une entreprise. Il garantit que les informations du bilan sont conformes à la vérité et constitue la base du bilan annuel."},
  {T:"section",x:"L'obligation légale"},
  {T:"hl",bg:"#fef2f2",b:"#C62828",ti:"CO art. 958 — Obligation d'inventaire",x:"Toute personne astreinte à tenir des livres doit dresser un inventaire. Il doit être effectué au début d'une activité, à la fin de chaque exercice et à la cessation d'activité. Conservation : 10 ans. Doit être daté et signé."},
  {T:"section",x:"Les 3 types d'inventaire"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Procédures d'inventaire",x:"• À jour fixe : comptage un jour précis (jour du bilan) — grande précision mais prend beaucoup de temps (voire fermeture temporaire)\n• Permanent (tournant) : par article, à n'importe quel moment de l'année — moins de charge ponctuelle\n• Par sondage à jour fixe : échantillon représentatif étendu à tout le stock — accord fiscal requis, interdit pour les articles de valeur"},
  {T:"section",x:"L'évaluation de l'inventaire"},
  {T:"text",x:"On compare la valeur théorique (comptable) avec la valeur réelle (physique). Les écarts peuvent venir de : erreurs de saisie, différences de livraison non détectées, pertes liées au produit (évaporation), dates échues, casse, vol."},
  {T:"section",x:"Les dispositions légales"},
  {T:"text",x:"La falsification intentionnelle d'un inventaire est considérée comme une falsification de bilan, pénalisée par une peine de prison ou une amende. Le propriétaire de l'entreprise est responsable de la saisie correcte."},
  {T:"gloss",items:[
    {term:"Inventaire",def:"Relevé précis de tous les actifs et passifs d'une entreprise ; base du bilan annuel."},
    {term:"CO art. 958",def:"Article du Code des obligations imposant l'obligation d'inventaire à toute personne tenant des livres."},
    {term:"Inventaire à jour fixe",def:"Comptage effectué un jour précis (jour du bilan) ; très précis mais long."},
    {term:"Inventaire permanent",def:"Comptage par article réparti sur toute l'année, à n'importe quel moment."},
    {term:"Inventaire par sondage",def:"Comptage d'un échantillon représentatif étendu à tout le stock ; interdit pour les articles de valeur."},
    {term:"Valeur théorique vs réelle",def:"Comparaison entre la valeur comptable (théorique) et la valeur physique réellement comptée."}
  ]}],
 questions:[
  {q:"Qu'est-ce qu'un inventaire ?",options:["Une liste de fournisseurs","Un relevé précis des actifs et passifs","Un catalogue de vente","Un planning de livraison"],answer:1},
  {q:"Quel article du CO impose l'obligation d'inventaire ?",options:["Art. 360","Art. 958","Art. 74","Art. 210"],answer:1},
  {q:"Combien de temps faut-il conserver un inventaire ?",options:["3 ans","5 ans","10 ans","À vie"],answer:2},
  {q:"Quels sont les 3 types d'inventaire ? (plusieurs réponses)",options:["À jour fixe","Permanent (tournant)","Par sondage à jour fixe","Par estimation libre"],answers:[0,1,2],multi:true},
  {q:"L'inventaire par sondage est interdit pour :",options:["Les petits articles","Les articles de valeur","Les denrées alimentaires","Les palettes"],answer:1},
  {q:"L'évaluation de l'inventaire compare :",options:["Deux fournisseurs","La valeur théorique et la valeur réelle","Le prix d'achat et de vente","Deux entrepôts"],answer:1},
  {q:"Quelles causes expliquent les écarts d'inventaire ? (plusieurs réponses)",options:["Le vol","La casse","Les dates échues","Une bonne gestion"],answers:[0,1,2],multi:true},
  {q:"La falsification intentionnelle d'un inventaire est :",options:["Tolérée","Considérée comme falsification de bilan (prison ou amende)","Sans conséquence","Une simple erreur"],answer:1}
 ]};

const CHB10 = {id:"cb10",num:10,mod:"B",title:"La préparation des commandes",icon:"📦",color:"#2E7D32",textColor:"#fff",
 content:[
  {T:"intro",x:"La préparation des commandes consiste à rassembler les marchandises en fonction de la commande du client. Elle repose sur un système de flux de matières et vise à minimiser les temps de traitement."},
  {T:"section",x:"Le système de flux de matières"},
  {T:"img",src:"/images/nb_prepa.png",alt:"Système de préparation des commandes : flux d'informations, de matières et organisation"},
  {T:"img",src:"/images/nb_flux.png",alt:"Système de flux de matières : préparation, déplacement, prélèvement, sortie"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Statique vs dynamique",x:"• Statique : le préparateur se déplace jusqu'à la marchandise pour prélever les articles\n• Dynamique : un système prélève lui-même la marchandise et l'achemine jusqu'à la zone de préparation"},
  {T:"section",x:"Les modes de dimension"},
  {T:"list",items:["À une dimension : déplacement uniquement horizontal","À plusieurs dimensions : déplacement horizontal ET vertical"]},
  {T:"section",x:"Pick and Pack"},
  {T:"text",x:"Avec le Pick and Pack, les commandes sont préparées et emballées en une seule opération : le poste d'emballage est supprimé. Possible seulement si les produits sont déjà emballés, le matériel normalisé et qu'aucun emballage compliqué n'est nécessaire."},
  {T:"img",src:"/images/nb_allee.png",alt:"Préparation sérielle vs préparation par allée de prélèvement (analyse ABC)"},
  {T:"section",x:"Les temps de préparation de commande"},
  {T:"hl",bg:"#fff8e1",b:"#f59e0b",ti:"Les 5 temps partiels",x:"• Temps d'organisation : récolter/classer les documents, préparer les contenants\n• Temps de déplacement : entre deux prélèvements (réduit par l'optimisation des trajets et le stockage selon la rotation)\n• Temps de prélèvement : accéder à l'article et le déposer dans le conteneur\n• Temps morts : lecture des documents, comptage, étiquetage\n• Temps perdu : improductif (pauses, attente de réapprovisionnement)"},
  {T:"img",src:"/images/nb_temps.png",alt:"Répartition des temps de préparation : organisation 14%, déplacement 24%, mort 17%, prélèvement 15%, perdu 30%"},
  {T:"gloss",items:[
    {term:"Préparation statique",def:"Le préparateur se déplace vers la marchandise pour la prélever."},
    {term:"Préparation dynamique",def:"Le système achemine automatiquement la marchandise jusqu'au préparateur."},
    {term:"Pick and Pack",def:"Préparation et emballage en une seule opération ; supprime le poste d'emballage."},
    {term:"Temps de déplacement",def:"Temps entre deux prélèvements ; réduit par l'optimisation des trajets."},
    {term:"Temps mort",def:"Opérations annexes nécessaires : lecture des documents, comptage, étiquetage."},
    {term:"Temps perdu",def:"Temps improductif (pauses, attentes) à minimiser par une bonne organisation."}
  ]}],
 questions:[
  {q:"Dans la préparation statique, qui se déplace ?",options:["La marchandise","Le préparateur","Le client","Le camion"],answer:1},
  {q:"Dans la préparation dynamique :",options:["Le préparateur va vers la marchandise","Le système achemine la marchandise vers le préparateur","Rien ne bouge","Le client prélève lui-même"],answer:1},
  {q:"La préparation à plusieurs dimensions implique un déplacement :",options:["Horizontal uniquement","Vertical uniquement","Horizontal et vertical","Circulaire"],answer:2},
  {q:"Le Pick and Pack permet de :",options:["Doubler l'emballage","Préparer et emballer en une seule opération","Supprimer la préparation","Augmenter les coûts"],answer:1},
  {q:"Quels sont des temps de préparation de commande ? (plusieurs réponses)",options:["Temps d'organisation","Temps de déplacement","Temps de prélèvement","Temps de livraison au client final"],answers:[0,1,2],multi:true},
  {q:"Comment réduire le temps de déplacement ? (plusieurs réponses)",options:["Optimisation des trajets","Stockage selon le taux de rotation","Regroupement de commandes","Augmenter la taille de l'entrepôt"],answers:[0,1,2],multi:true},
  {q:"Le temps perdu correspond à :",options:["Le temps de prélèvement","Le temps improductif (pauses, attentes)","Le temps d'emballage","Le temps de transport"],answer:1},
  {q:"Le Pick and Pack est possible si :",options:["Les produits sont déjà emballés et le matériel normalisé","L'emballage est compliqué","Les produits sont en vrac","Aucune condition"],answer:0}
 ]};
...
const MODULE_B_RAND_POOL = [
  ...
  ...CHB7.questions.map(q=>({...q,_ch:"CHB7",_chTitle:"Systèmes de stockage",_chColor:CHB7.color,_chTextColor:CHB7.textColor})),
  ...CHB8.questions.map(q=>({...q,_ch:"CHB8",_chTitle:"Gestion des stocks",_chColor:CHB8.color,_chTextColor:CHB8.textColor})),
  ...CHB9.questions.map(q=>({...q,_ch:"CHB9",_chTitle:"L'inventaire",_chColor:CHB9.color,_chTextColor:CHB9.textColor})),
  ...CHB10.questions.map(q=>({...q,_ch:"CHB10",_chTitle:"Préparation des commandes",_chColor:CHB10.color,_chTextColor:CHB10.textColor})),
];

const MODULE_B = [CHB1,CHB2,CHB3,CHB4,CHB5,CHB6,CHB7,CHB8,CHB9,CHB10];
...
const CHD7 = {id:"cd7",num:7,mod:"D",title:"L'élimination des déchets",icon:"♻️",color:"#C62828",textColor:"#fff",
 content:[
  {T:"intro",x:"Un déchet, c'est « une mauvaise matière au mauvais moment, dans la mauvaise situation et au mauvais endroit ». L'importance de l'élimination s'est renforcée : conscience écologique, pression du consommateur, protection de l'environnement, hausse des coûts."},
  {T:"section",x:"Les modes d'élimination"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Les 3 types de décharges (LPE)",x:"• Matériaux inertes : déchets quasi non polluants\n• Résidus stabilisés : substances nocives neutralisées\n• Bioactives : équipées pour supporter les processus chimiques et biologiques"},
  {T:"section",x:"L'incinération — le rôle de l'UIOM"},
  {T:"text",x:"Les déchets inflammables et non recyclables sont incinérés en UIOM (Usine d'Incinération des Ordures Ménagères). Cela réduit le volume des déchets de 90% et leur poids de 75%. Seules les UIOM ont des cheminées adaptées qui limitent les rejets. Elles génèrent environ 25% d'électricité et le reste en chauffage."},
  {T:"section",x:"Les catégories de déchets"},
  {T:"list",items:["Déchets de chantier : construction, démolition, industrie (hors spéciaux/urbains)","Déchets urbains : ménages, déchets mixtes, encombrants, tri","Déchets spéciaux : contrôlés par les cantons et l'OMoD (piles, batteries, métaux lourds)","Pneus usagés : dépôt en décharge interdit depuis les années 2000","Alu : la refonte économise 95% d'énergie","Fer blanc : taux de récupération de 79%"]},
  {T:"img",src:"/images/nd_veva.png",alt:"Légende d'une étiquette de déchets VEVA : matière valorisable, groupe OFEV, classification ADR/SDR"},
  {T:"section",x:"Le cadre légal"},
  {T:"hl",bg:"#e3f2fd",b:"#1565C0",ti:"Lois et ordonnances",x:"• Constitution fédérale art. 74 → Loi sur la protection de l'environnement (LPE)\n• OTD : réduction, traitement, décharges contrôlées, UIOM, compostage\n• OMoD : mouvements de déchets en Suisse et transfrontaliers (déchets spéciaux)\n• OREA : reprise et élimination des appareils électriques et électroniques"},
  {T:"gloss",items:[
    {term:"UIOM",def:"Usine d'Incinération des Ordures Ménagères : réduit le volume de 90% et le poids de 75%, produit chaleur et électricité."},
    {term:"Décharge bioactive",def:"Décharge équipée pour supporter les processus chimiques et biologiques des déchets."},
    {term:"LPE",def:"Loi sur la Protection de l'Environnement (CF art. 74), base de la gestion des déchets."},
    {term:"OTD",def:"Ordonnance sur le Traitement des Déchets : décharges contrôlées, UIOM, compostage."},
    {term:"OMoD",def:"Ordonnance sur les Mouvements de Déchets : mouvements en Suisse et transfrontaliers, déchets spéciaux."},
    {term:"OREA",def:"Ordonnance sur la restitution, reprise et élimination des appareils électriques et électroniques."}
  ]}],
 questions:[
  {q:"De combien l'incinération en UIOM réduit-elle le VOLUME des déchets ?",options:["50%","75%","90%","25%"],answer:2},
  {q:"De combien l'UIOM réduit-elle le POIDS des déchets ?",options:["75%","90%","50%","25%"],answer:0},
  {q:"Quels sont les 3 types de décharges ? (plusieurs réponses)",options:["Matériaux inertes","Résidus stabilisés","Bioactives","Radioactives permanentes"],answers:[0,1,2],multi:true},
  {q:"Quel article de la Constitution fédérale fonde la LPE ?",options:["Art. 74","Art. 958","Art. 360","Art. 145"],answer:0},
  {q:"Quelle ordonnance régit les mouvements de déchets spéciaux ?",options:["OTD","OMoD","OREA","OPair"],answer:1},
  {q:"La refonte de l'aluminium permet d'économiser :",options:["50% d'énergie","75% d'énergie","95% d'énergie","25% d'énergie"],answer:2},
  {q:"Depuis quand le dépôt de pneus usagés en décharge est-il interdit ?",options:["Les années 1990","Les années 2000","Les années 2010","1985"],answer:1},
  {q:"L'UIOM génère environ quelle part d'électricité ?",options:["25%","50%","75%","90%"],answer:0}
 ]};

const CHD8 = {id:"cd8",num:8,mod:"D",title:"Les déchets spéciaux",icon:"☣️",color:"#C62828",textColor:"#fff",
 content:[
  {T:"intro",x:"Les déchets spéciaux nécessitent des mesures particulières pour leur élimination. Ils regroupent les produits chimiques (solvants), médicaments périmés, batteries et piles, huiles usagées."},
  {T:"section",x:"Caractéristiques des déchets spéciaux"},
  {T:"hl",bg:"#fef2f2",b:"#C62828",ti:"Ils sont :",x:"• Nocifs pour la santé et l'environnement\n• Explosifs\n• Inflammables\n• Infectieux"},
  {T:"text",x:"Paracelse a dit : « la quantité détermine le danger potentiel ». Les déchets spéciaux figurent dans l'ordonnance du DETEC (Département fédéral de l'environnement, des transports, de l'énergie et de la communication)."},
  {T:"section",x:"La manutention et le stockage"},
  {T:"list",items:["Interdiction d'ouvrir le contenant","Porter des gants de protection et des lunettes en cas de risque de projection","Stocker à l'abri des intempéries, à l'écart de substances inconnues","Utiliser des contenants étanches (bac de rétention)","Protéger de tout accès non autorisé"]},
  {T:"section",x:"L'élimination"},
  {T:"text",x:"L'élimination relève de spécialistes. Les particuliers rapportent les déchets aux points de vente, les entreprises s'adressent au fournisseur. Les déchets spéciaux ne peuvent être remis qu'à une entreprise disposant d'une autorisation du canton."},
  {T:"gloss",items:[
    {term:"Déchet spécial",def:"Déchet nocif, explosif, inflammable ou infectieux nécessitant des mesures d'élimination particulières."},
    {term:"DETEC",def:"Département fédéral de l'Environnement, des Transports, de l'Énergie et de la Communication, qui liste les déchets spéciaux."},
    {term:"Bac de rétention",def:"Contenant étanche recueillant les fuites de substances dangereuses lors du stockage."},
    {term:"Autorisation cantonale",def:"Permis requis pour qu'une entreprise puisse recueillir et traiter des déchets spéciaux."},
    {term:"Principe de Paracelse",def:"« La quantité détermine le danger potentiel » — la dose fait le poison."}
  ]}],
 questions:[
  {q:"Que regroupent les déchets spéciaux ? (plusieurs réponses)",options:["Solvants chimiques","Médicaments périmés","Batteries et piles","Carton propre"],answers:[0,1,2],multi:true},
  {q:"Les déchets spéciaux sont notamment : (plusieurs réponses)",options:["Nocifs","Explosifs","Inflammables","Recyclables comme le papier"],answers:[0,1,2],multi:true},
  {q:"Que ne faut-il jamais faire avec un contenant de déchet spécial ?",options:["Le déplacer","L'ouvrir","Le stocker","L'étiqueter"],answer:1},
  {q:"À qui les particuliers doivent-ils rapporter les déchets spéciaux ?",options:["À la déchetterie sauvage","Aux points de vente","Dans les ordures ménagères","Au compost"],answer:1},
  {q:"Quelle autorisation faut-il pour recueillir des déchets spéciaux ?",options:["Une autorisation fédérale","Une autorisation du canton","Aucune","Une autorisation communale"],answer:1},
  {q:"Quel département fédéral liste les déchets spéciaux ?",options:["DETEC","DFAE","DDPS","DFF"],answer:0},
  {q:"Quelle protection porter en cas de risque de projection ?",options:["Casque uniquement","Gants et lunettes","Rien","Chaussures de sécurité uniquement"],answer:1},
  {q:"La citation de Paracelse rappelle que :",options:["Tout est toxique","La quantité détermine le danger","Rien n'est dangereux","Les déchets sont inutiles"],answer:1}
 ]};

const CHD9 = {id:"cd9",num:9,mod:"D",title:"Le recyclage",icon:"🔄",color:"#C62828",textColor:"#fff",
 content:[
  {T:"intro",x:"Recycler signifie redonner de la valeur à une chose. Le recyclage est le processus de collecte, tri, traitement et valorisation des matières, qui deviennent des matières premières secondaires."},
  {T:"section",x:"L'importance du recyclage"},
  {T:"text",x:"Le recyclage réduit la quantité de déchets, préserve les matières premières et diminue les émissions de CO2 et l'utilisation d'énergie. Mais il ne fonctionne que lorsqu'il présente une rentabilité économique."},
  {T:"section",x:"Les systèmes de transport des déchets"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Deux systèmes",x:"• Système de livraison : le client assure lui-même le transport jusqu'au point de collecte\n• Système d'enlèvement : c'est le ramassage des ordures"},
  {T:"text",x:"Le bon fonctionnement dépend du système de collecte : si le client doit faire des kilomètres, la tentation de choisir un autre moyen est plus grande."},
  {T:"section",x:"Le financement du recyclage"},
  {T:"hl",bg:"#fff8e1",b:"#f59e0b",ti:"Les mécanismes de financement",x:"• CAR / CAE : Contribution Anticipée de Recyclage / d'Élimination, comprise dans le prix du produit\n• TEA : Taxe d'Élimination Anticipée (ex. à l'achat d'une pile). Tout commerçant doit reprendre piles et batteries jusqu'à 5 kg\n• Point vert (depuis 1990) : le fabricant a payé une licence pour la collecte, le tri et le recyclage"},
  {T:"section",x:"Les organisations de recyclage en Suisse"},
  {T:"list",items:["SWICO : élimination et recyclage des appareils électroniques usagés","SENS : appareils électroménagers, machines, outils de jardinage, luminaires","Papier : ne peut pas être recyclé à l'infini","Métal : économise les coûts et l'énergie"]},
  {T:"gloss",items:[
    {term:"Recyclage",def:"Processus de collecte, tri, traitement et valorisation des matières en matières premières secondaires."},
    {term:"Matière première secondaire",def:"Matière issue du recyclage, réutilisée dans un nouveau cycle de production."},
    {term:"CAR / CAE",def:"Contribution Anticipée de Recyclage / d'Élimination, incluse dans le prix d'achat."},
    {term:"TEA",def:"Taxe d'Élimination Anticipée, payée à l'achat (ex. piles). Reprise obligatoire jusqu'à 5 kg."},
    {term:"Point vert",def:"Label (depuis 1990) indiquant que le fabricant a payé une licence pour le recyclage de l'emballage."},
    {term:"SWICO / SENS",def:"Organisations suisses de recyclage : SWICO (électronique), SENS (électroménager, outils)."}
  ]}],
 questions:[
  {q:"Que signifie recycler ?",options:["Jeter proprement","Redonner de la valeur à une chose","Incinérer","Enterrer"],answer:1},
  {q:"Le recyclage ne fonctionne que s'il :",options:["Est obligatoire","Présente une rentabilité économique","Est gratuit","Est rapide"],answer:1},
  {q:"Quels sont les deux systèmes de transport des déchets ? (plusieurs réponses)",options:["Système de livraison","Système d'enlèvement","Système d'incinération","Système d'enfouissement"],answers:[0,1],multi:true},
  {q:"Que signifie TEA ?",options:["Taxe d'Élimination Anticipée","Taux d'Énergie Annuel","Tarif Écologique Appliqué","Test d'Élimination Autorisé"],answer:0},
  {q:"Jusqu'à quel poids un commerçant doit-il reprendre les piles ?",options:["1 kg","5 kg","10 kg","Sans limite"],answer:1},
  {q:"Depuis quand existe le Point vert ?",options:["1980","1990","2000","2010"],answer:1},
  {q:"Que recycle SWICO ?",options:["Les appareils électroniques usagés","Les déchets verts","Le verre","Le textile"],answer:0},
  {q:"Que recycle SENS ?",options:["Le papier","L'électroménager, machines, outils de jardinage","Le pétrole","Les médicaments"],answer:1}
 ]};

const CHD10 = {id:"cd10",num:10,mod:"D",title:"L'élimination dans les entreprises",icon:"🏭",color:"#C62828",textColor:"#fff",
 content:[
  {T:"intro",x:"Les entreprises de logistique produisent pratiquement tous les types de déchets, mais les matériaux d'emballage en constituent la plus grande partie. Les concepts d'élimination sont aussi divers que les entreprises elles-mêmes."},
  {T:"img",src:"/images/modD_img16.png",alt:"Organisations suisses de recyclage et d'élimination"},
  {T:"section",x:"La check-list OFEV — groupes de déchets"},
  {T:"hl",bg:"#fef2f2",b:"#C62828",ti:"Les 5 groupes de déchets",x:"• Groupe A : déchets inoffensifs\n• Groupe B : risque de contamination\n• Groupe C : agents infectieux transmissibles\n• Groupe D : déchets spéciaux\n• Groupe E : déchets médicaux"},
  {T:"section",x:"Les exportations illégales de déchets"},
  {T:"text",x:"Les exportations illégales ont fortement augmenté, sous forme d'appareils d'occasion (PC, télés) exportés vers des pays en développement. La Convention de Bâle (1989) sur le contrôle des mouvements transfrontaliers de déchets dangereux vise à arrêter ces exportations."},
  {T:"section",x:"Le littering"},
  {T:"text",x:"Les déchets sauvages (littering) s'observent dans la rue, les lieux publics, les parcs et après les manifestations. La majeure partie est constituée d'emballages à usage unique, de produits d'impression et de mégots de cigarettes."},
  {T:"section",x:"Les systèmes de management environnemental (SME)"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Le SME et les normes ISO",x:"Un SME gère l'entreprise dans une optique environnementale. La norme ISO 14001 certifie les SME. Avantages : protection systématique de l'environnement, risques minimisés, entreprise plus compétitive, meilleure image. La norme ISO 20121 s'applique aux activités événementielles durables."},
  {T:"gloss",items:[
    {term:"Convention de Bâle",def:"Accord de 1989 contrôlant les mouvements transfrontaliers de déchets dangereux pour stopper les exportations illégales."},
    {term:"Littering",def:"Abandon de déchets sauvages dans l'espace public (emballages, mégots, imprimés)."},
    {term:"SME",def:"Système de Management Environnemental : gestion de l'entreprise dans une optique écologique."},
    {term:"ISO 14001",def:"Norme internationale certifiant les systèmes de management environnemental."},
    {term:"ISO 20121",def:"Norme appliquée au développement durable des activités événementielles."},
    {term:"OFEV",def:"Office Fédéral de l'Environnement, qui établit les check-lists de gestion des déchets."}
  ]}],
 questions:[
  {q:"Quel type de déchet constitue la plus grande partie dans la logistique ?",options:["Les déchets médicaux","Les matériaux d'emballage","Les piles","Les huiles"],answer:1},
  {q:"En quelle année la Convention de Bâle a-t-elle été adoptée ?",options:["1979","1989","1999","2009"],answer:1},
  {q:"Que vise la Convention de Bâle ?",options:["Augmenter le recyclage","Contrôler les mouvements transfrontaliers de déchets dangereux","Interdire les UIOM","Taxer les emballages"],answer:1},
  {q:"Quels groupes de déchets de la check-list OFEV concernent les risques sanitaires ? (plusieurs réponses)",options:["Groupe B (contamination)","Groupe C (infectieux)","Groupe E (médicaux)","Groupe A (inoffensifs)"],answers:[0,1,2],multi:true},
  {q:"De quoi est constituée la majeure partie du littering ? (plusieurs réponses)",options:["Emballages à usage unique","Produits d'impression","Mégots de cigarettes","Appareils électroniques"],answers:[0,1,2],multi:true},
  {q:"Quelle norme ISO certifie les systèmes de management environnemental ?",options:["ISO 9001","ISO 14001","ISO 20121","ISO 50001"],answer:1},
  {q:"Quelle norme ISO s'applique aux événements durables ?",options:["ISO 14001","ISO 20121","ISO 9001","ISO 45001"],answer:1},
  {q:"Le groupe A de la check-list OFEV correspond aux déchets :",options:["Spéciaux","Inoffensifs","Infectieux","Médicaux"],answer:1}
 ]};
...
const MODULE_D_RAND_POOL = [
  ...
  ...CHD7.questions.map(q=>({...q,_ch:"CHD7",_chTitle:"Élimination des déchets",_chColor:CHD7.color,_chTextColor:CHD7.textColor})),
  ...CHD8.questions.map(q=>({...q,_ch:"CHD8",_chTitle:"Déchets spéciaux",_chColor:CHD8.color,_chTextColor:CHD8.textColor})),
  ...CHD9.questions.map(q=>({...q,_ch:"CHD9",_chTitle:"Le recyclage",_chColor:CHD9.color,_chTextColor:CHD9.textColor})),
  ...CHD10.questions.map(q=>({...q,_ch:"CHD10",_chTitle:"Élimination en entreprise",_chColor:CHD10.color,_chTextColor:CHD10.textColor})),
];

const MODULE_D = [CHD1,CHD2,CHD3,CHD4,CHD5,CHD6,CHD7,CHD8,CHD9,CHD10];
...
const CHE7 = {id:"ce7",num:7,mod:"E",title:"La vente",icon:"🛒",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"Celui qui souhaite vendre doit connaître les besoins des clients potentiels. Un besoin est un manque lié au souhait de le combler."},
  {T:"section",x:"Les motifs d'achat"},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Les 4 motifs d'achat",x:"• Curiosité : le produit plaît, envie d'essayer quelque chose de nouveau\n• Augmentation de l'estime de soi : achat de symboles de statut social\n• Passion : ex. achat d'une vieille voiture de collection\n• Envie d'acheter : aucun besoin réel, juste l'envie"},
  {T:"section",x:"La psychologie de vente"},
  {T:"text",x:"Elle étudie le comportement d'achat : présentation à hauteur des yeux, présentation devant la caisse, odeurs. Avec les cartes client, les commerçants connaissent les habitudes d'achat pour personnaliser les offres."},
  {T:"section",x:"La promotion des ventes"},
  {T:"list",items:["Les actions : baisse de prix (la plus fréquente) — introduit de nouveaux produits, réduit les stocks excédentaires, écoule fins de série et produits proches de la péremption","Démonstrations et dégustations : démonstration de produits, échantillons de nourriture","Vente additionnelle : proposer un produit complémentaire (billet de tram avec le billet de train, piles avec l'appareil photo)"]},
  {T:"gloss",items:[
    {term:"Besoin",def:"Manque lié au souhait de le combler ; point de départ de tout acte d'achat."},
    {term:"Motif d'achat",def:"Raison qui pousse à acheter : curiosité, estime de soi, passion ou simple envie."},
    {term:"Psychologie de vente",def:"Étude du comportement d'achat (présentation, odeurs, emplacement) pour favoriser la vente."},
    {term:"Promotion des ventes",def:"Ensemble des mesures pour augmenter les ventes (actions, démos, vente additionnelle)."},
    {term:"Vente additionnelle",def:"Proposition d'un produit complémentaire au moment de l'achat principal."}
  ]}],
 questions:[
  {q:"Qu'est-ce qu'un besoin ?",options:["Un produit en stock","Un manque lié au souhait de le combler","Une promotion","Un prix bas"],answer:1},
  {q:"Quels sont des motifs d'achat ? (plusieurs réponses)",options:["Curiosité","Augmentation de l'estime de soi","Passion","Obligation légale"],answers:[0,1,2],multi:true},
  {q:"La présentation à hauteur des yeux relève de :",options:["La comptabilité","La psychologie de vente","La logistique","La production"],answer:1},
  {q:"À quoi servent les cartes client ?",options:["À payer moins cher","À connaître les habitudes d'achat et personnaliser les offres","À remplacer la monnaie","À éviter les files"],answer:1},
  {q:"Quelle est la forme la plus fréquente de promotion des ventes ?",options:["Les démonstrations","Les actions (baisse de prix)","La vente additionnelle","La publicité TV"],answer:1},
  {q:"Proposer des piles avec un appareil photo est un exemple de :",options:["Action","Vente additionnelle","Dégustation","Démonstration"],answer:1},
  {q:"Les actions permettent de : (plusieurs réponses)",options:["Introduire de nouveaux produits","Réduire les stocks excédentaires","Écouler les fins de série","Augmenter les prix"],answers:[0,1,2],multi:true},
  {q:"Acheter un symbole de statut social correspond au motif :",options:["Curiosité","Augmentation de l'estime de soi","Passion","Nécessité"],answer:1}
 ]};

const CHE8 = {id:"ce8",num:8,mod:"E",title:"Prospection et étude de marché",icon:"🔍",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"Les produits et services doivent convenir aux clients, sinon ils ne les achètent pas. L'entreprise doit adapter continuellement son offre aux besoins des clients."},
  {T:"section",x:"La prospection de marché"},
  {T:"list",items:["Retours d'informations du personnel de vente","Rapports des collaborateurs externes","Commentaires clients","Observation de la concurrence","Étude de presse"]},
  {T:"section",x:"L'étude de marché"},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Primaire vs secondaire",x:"• Primaire : informations « de première main », recueillies directement auprès des personnes concernées (enquêtes, tests produits)\n• Secondaire (enquête de bureau) : informations « de seconde main » — statistiques de vente, comptabilité, presse. Moins coûteuse que l'étude primaire."},
  {T:"text",x:"La conjoncture (évolution de l'ensemble de l'économie) est l'un des facteurs les plus importants pour prévoir l'évolution d'un marché. Si l'économie va bien, les consommateurs dépensent plus."},
  {T:"section",x:"Les méthodes d'échantillonnage (enquêtes clients)"},
  {T:"hl",bg:"#e3f2fd",b:"#1565C0",ti:"Trois méthodes",x:"• Aléatoire : personnes interrogées au hasard — plus le nombre est élevé, plus tous les types de clients sont représentés\n• Ciblé : seuls les clients aux caractéristiques importantes (branche, taille, importance)\n• Par quota : interroge selon la proportion réelle des clients (ex. 60 hommes / 40 femmes)"},
  {T:"text",x:"Il faut distinguer les exigences (objectives, liées au produit) des attentes (subjectives, liées à la personnalité du client)."},
  {T:"gloss",items:[
    {term:"Prospection de marché",def:"Recherche d'informations via retours du personnel, commentaires clients, observation de la concurrence."},
    {term:"Étude de marché primaire",def:"Informations de première main recueillies directement auprès des personnes concernées."},
    {term:"Étude de marché secondaire",def:"Informations de seconde main (statistiques, comptabilité, presse) ; moins coûteuse."},
    {term:"Conjoncture",def:"Évolution de l'ensemble de l'économie ; facteur clé des prévisions de marché."},
    {term:"Échantillonnage par quota",def:"Interrogation selon la proportion réelle des clients (ex. 60% hommes / 40% femmes)."},
    {term:"Exigences vs attentes",def:"Exigences = objectives (liées au produit) ; attentes = subjectives (liées au client)."}
  ]}],
 questions:[
  {q:"L'étude de marché primaire recueille des informations :",options:["De seconde main","De première main, directement auprès des concernés","Dans la presse","Dans la comptabilité"],answer:1},
  {q:"L'étude de marché secondaire utilise : (plusieurs réponses)",options:["Statistiques de vente","Données de comptabilité","Informations de presse","Enquêtes directes auprès des clients"],answers:[0,1,2],multi:true},
  {q:"Quel facteur est essentiel pour prévoir l'évolution d'un marché ?",options:["La météo","La conjoncture","La couleur des produits","Le nombre d'employés"],answer:1},
  {q:"L'échantillonnage par quota consiste à :",options:["Interroger au hasard","Interroger selon la proportion réelle des clients","Interroger uniquement les hommes","Ne pas interroger"],answer:1},
  {q:"Les exigences d'un client sont :",options:["Subjectives","Objectives, liées au produit","Imprévisibles","Sans importance"],answer:1},
  {q:"Les attentes d'un client sont :",options:["Objectives","Subjectives, liées à sa personnalité","Toujours identiques","Liées au prix uniquement"],answer:1},
  {q:"Quels éléments font partie de la prospection de marché ? (plusieurs réponses)",options:["Commentaires clients","Observation de la concurrence","Étude de presse","Inventaire physique"],answers:[0,1,2],multi:true},
  {q:"L'étude de marché secondaire est :",options:["Plus chère que la primaire","Moins chère que la primaire","Identique en coût","Gratuite"],answer:1}
 ]};

const CHE9 = {id:"ce9",num:9,mod:"E",title:"Que signifie produire ?",icon:"⚙️",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"Le mot « produire » vient du latin producere, qui signifie faire avancer, engendrer ou créer. L'homme fabrique des choses à partir d'un ou plusieurs matériaux."},
  {T:"section",x:"Les matériaux de la production"},
  {T:"text",x:"Ces matériaux peuvent être des matières premières, des produits semi-finis ou des produits finis. Le facteur essentiel de la production est l'utilisation de main d'œuvre ou d'énergie. Exemples : la ménagère produit un repas, le boulanger produit du pain."},
  {T:"section",x:"Le processus de production"},
  {T:"text",x:"Chaque forme de production repose sur un déroulement appelé processus."},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Étapes d'un processus de production",x:"• Planification et approvisionnement : besoins, dimensions, budget\n• Préparation de la production : déchargement, stockage intermédiaire\n• Contrôle du matériel : concordance des pièces avec la nomenclature\n• Production : fabrication à l'établi\n• Élimination des déchets : attention aux matériaux recyclables (carton, papier)"},
  {T:"gloss",items:[
    {term:"Produire",def:"Du latin producere : faire avancer, engendrer, créer quelque chose à partir de matériaux."},
    {term:"Matière première",def:"Matériau brut provenant de la nature, point de départ de la production."},
    {term:"Produit semi-fini",def:"Matière première déjà transformée mais nécessitant d'autres étapes."},
    {term:"Produit fini",def:"Produit ne nécessitant aucun traitement supplémentaire."},
    {term:"Processus",def:"Déroulement structuré sur lequel repose chaque forme de production."}
  ]}],
 questions:[
  {q:"De quel mot latin vient « produire » ?",options:["Productum","Producere","Productio","Produco"],answer:1},
  {q:"Que signifie producere ?",options:["Détruire","Faire avancer, engendrer, créer","Vendre","Stocker"],answer:1},
  {q:"Quel est le facteur essentiel de la production ?",options:["Le marketing","L'utilisation de main d'œuvre ou d'énergie","La publicité","Le stockage"],answer:1},
  {q:"À partir de quoi l'homme fabrique-t-il ? (plusieurs réponses)",options:["Matières premières","Produits semi-finis","Produits finis","Déchets uniquement"],answers:[0,1,2],multi:true},
  {q:"Sur quoi repose chaque forme de production ?",options:["Un processus","Le hasard","La publicité","Le stockage"],answer:0},
  {q:"Un boulanger qui fait du pain est un exemple de :",options:["Distribution","Production","Stockage","Vente"],answer:1},
  {q:"Lors du contrôle du matériel, on vérifie :",options:["Le prix","La concordance des pièces avec la nomenclature","La couleur","La date de vente"],answer:1},
  {q:"Quels déchets de production sont facilement recyclables ?",options:["Le carton et le papier","Les piles","Les solvants","Les huiles"],answer:0}
 ]};

const CHE10 = {id:"ce10",num:10,mod:"E",title:"La logistique de production",icon:"🏭",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"La logistique de production tient une place prépondérante dans le processus logistique. Elle est étroitement liée à la logistique d'approvisionnement et de stockage. Les logisticiens assurent le flux de marchandises de l'entrée à la sortie."},
  {T:"img",src:"/images/ne_prod.png",alt:"La logistique de production : flux de matériaux dans l'entreprise"},
  {T:"section",x:"Les objectifs de la logistique de production"},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Les 5 objectifs",x:"• Temps de fabrication court\n• Respect des délais\n• Stock peu élevé\n• Qualité élevée\n• Coûts de production les plus faibles possibles"},
  {T:"section",x:"Les types de fabrication selon le nombre de produits"},
  {T:"list",items:["Fabrication unitaire : chaque produit est une pièce unique (tableau, costume sur mesure, bague de mariage)","Fabrication en série : nombre limité du même type (iPhone, journal quotidien)","Fabrication par lots : production par lots individuels (bière, pain)","Production de masse : grande quantité de biens homogènes pour un marché anonyme (dragibus, électricité)"]},
  {T:"section",x:"L'organisation de la fabrication"},
  {T:"hl",bg:"#e3f2fd",b:"#1565C0",ti:"Quatre organisations",x:"• À l'établi : du début à la fin par une personne/groupe (pièces uniques, petites séries)\n• En atelier : postes regroupés par tâches similaires, le produit circule\n• À la chaîne : étapes consécutives dans le même ordre, rythme fixé par la chaîne\n• De chantier : main d'œuvre et moyens amenés sur le chantier"},
  {T:"text",x:"La Lean production (production à flux tendu) vise un fonctionnement le plus allégé possible : durée de stockage courte, petites séries, grande flexibilité et bon travail d'équipe."},
  {T:"gloss",items:[
    {term:"Logistique de production",def:"Gestion du flux de marchandises de l'entrée à la sortie dans le processus de fabrication."},
    {term:"Fabrication unitaire",def:"Production de pièces uniques (tableau, costume sur mesure)."},
    {term:"Fabrication en série",def:"Production d'un nombre limité de produits identiques (iPhone)."},
    {term:"Production de masse",def:"Grande quantité de biens homogènes pour un marché anonyme."},
    {term:"Fabrication à la chaîne",def:"Étapes consécutives dans un ordre fixe ; rythme déterminé par la chaîne."},
    {term:"Lean production",def:"Production à flux tendu, allégée : stocks courts, petites séries, flexibilité."}
  ]}],
 questions:[
  {q:"Quels sont des objectifs de la logistique de production ? (plusieurs réponses)",options:["Temps de fabrication court","Stock peu élevé","Qualité élevée","Coûts de production élevés"],answers:[0,1,2],multi:true},
  {q:"Un costume sur mesure relève de la fabrication :",options:["En série","Unitaire","De masse","Par lots"],answer:1},
  {q:"La production de dragibus est une fabrication :",options:["Unitaire","En série","De masse","À l'établi"],answer:2},
  {q:"La fabrication à la chaîne se caractérise par :",options:["Une personne fait tout","Des étapes consécutives dans le même ordre","Aucun ordre","Du travail sur chantier"],answer:1},
  {q:"La production de bière ou de pain relève de la fabrication :",options:["Unitaire","Par lots","De masse","De chantier"],answer:1},
  {q:"Que vise la Lean production ?",options:["De gros stocks","Un fonctionnement allégé à flux tendu","Des grandes séries uniquement","Aucune flexibilité"],answer:1},
  {q:"La fabrication à l'établi convient pour :",options:["La production de masse","Les pièces uniques et petites séries","Les chaînes automobiles","Les marchés anonymes"],answer:1},
  {q:"Dans la fabrication en atelier :",options:["Le produit circule entre postes regroupés par tâches","Tout est fait sur un chantier","Une seule personne fait tout","Le rythme est fixé par une chaîne"],answer:0}
 ]};

const CHE11 = {id:"ce11",num:11,mod:"E",title:"Les flux de matériel",icon:"🔁",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"Le flux de matériel d'une entreprise de production dépend du genre de produits fabriqués. Plusieurs concepts de gestion permettent d'optimiser ce flux."},
  {T:"section",x:"Le principe Kanban"},
  {T:"img",src:"/images/ne_kanban.png",alt:"Le cycle Kanban en 6 étapes"},
  {T:"text",x:"Kanban (japonais = étiquette) a été développé par Toyota en 1947. C'est une méthode « pull » (flux tiré) qui s'oriente exclusivement sur les besoins du point concerné de la production."},
  {T:"section",x:"Les autres concepts de flux"},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Concepts clés",x:"• Two-bin : réapprovisionnement déclenché quand le 1er contenant est vide ; le stock restant suffit jusqu'à l'arrivée — convient si les délais sont courts\n• Contrôle optique : on commande quand une marque devient visible dans le contenant\n• Jidoka (japonais = automation autonome) : exploitation d'une machine sans surveillance humaine"},
  {T:"section",x:"Le Just-in-Time (JIT)"},
  {T:"hl",bg:"#e8f5e9",b:"#2E7D32",ti:"Just-in-Time",x:"Concept de commande de matériel sans stockage intermédiaire : les produits sont finis ou livrés précisément au moment où ils sont nécessaires. Baisse les coûts de stockage. Les stocks doivent être saisis et gérés en ligne à tout moment. Le Just-in-Sequence est un perfectionnement du JIT."},
  {T:"gloss",items:[
    {term:"Kanban",def:"Méthode « pull » (flux tiré) japonaise (Toyota 1947) basée sur des étiquettes orientées sur les besoins de production."},
    {term:"Flux tiré (pull)",def:"Système où la production est déclenchée par la demande réelle en aval."},
    {term:"Two-bin",def:"Réapprovisionnement déclenché lorsque le premier des deux contenants est vide."},
    {term:"Jidoka",def:"Automation autonome : exploitation d'une machine sans surveillance humaine."},
    {term:"Just-in-Time (JIT)",def:"Livraison du matériel au moment exact où il est nécessaire, sans stockage intermédiaire."},
    {term:"Just-in-Sequence",def:"Perfectionnement du JIT intégrant l'ordre exact d'utilisation des pièces."}
  ]}],
 questions:[
  {q:"Que signifie « Kanban » en japonais ?",options:["Flux","Étiquette","Stock","Commande"],answer:1},
  {q:"Qui a développé le Kanban et en quelle année ?",options:["Ford en 1920","Toyota en 1947","Denso en 1994","Honda en 1960"],answer:1},
  {q:"Le Kanban est une méthode :",options:["Push (flux poussé)","Pull (flux tiré)","Aléatoire","Manuelle uniquement"],answer:1},
  {q:"Le système Two-bin déclenche le réapprovisionnement quand :",options:["Les deux contenants sont vides","Le premier contenant est vide","Le stock est plein","La commande arrive"],answer:1},
  {q:"Que signifie Jidoka ?",options:["Flux tiré","Automation autonome","Stockage intermédiaire","Étiquette"],answer:1},
  {q:"Le Just-in-Time consiste à :",options:["Stocker un maximum","Livrer au moment exact où c'est nécessaire, sans stock intermédiaire","Produire à l'avance","Commander une fois par an"],answer:1},
  {q:"Quel est l'avantage principal du JIT ?",options:["Augmenter les stocks","Baisser les coûts de stockage","Ralentir la production","Augmenter les délais"],answer:1},
  {q:"Le Just-in-Sequence est :",options:["L'opposé du JIT","Un perfectionnement du JIT","Une méthode push","Un type de Kanban manuel"],answer:1}
 ]};

const CHE12 = {id:"ce12",num:12,mod:"E",title:"Planification et contrôle (PCP)",icon:"📈",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"La planification et le contrôle de la production (PCP) désignent le fait de planifier, mettre en œuvre et contrôler la production en termes de quantités et de délais. La PCP concerne aussi l'approvisionnement et la distribution."},
  {T:"section",x:"Les tâches de la PCP"},
  {T:"list",items:["Planification du travail et des durées de fabrication","Gestion des marchandises (coordination approvisionnement et stockage)","Détermination du type et de l'organisation de fabrication","Expédition (logistique de distribution)"]},
  {T:"section",x:"L'optimisation des délais"},
  {T:"text",x:"La durée de fabrication (temps pour passer toutes les étapes) est un facteur essentiel."},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Mesures d'optimisation",x:"• Utilisation d'un système PCP\n• Réduction de la taille des lots pour éviter un goulot d'étranglement\n• Réduction du temps d'adaptation des machines\n• Prévention des durées de transport, attente ou stockage trop longues"},
  {T:"section",x:"La réduction des stocks"},
  {T:"text",x:"Les stocks sont nécessaires pour : maintenir la capacité de livraison, compenser les délais de réapprovisionnement, absorber les fluctuations de la demande, produire des séries en quantités économiques."},
  {T:"gloss",items:[
    {term:"PCP",def:"Planification et Contrôle de la Production : planifier, mettre en œuvre et contrôler la production en quantités et délais."},
    {term:"Durée de fabrication",def:"Temps nécessaire à un produit pour passer par toutes les étapes de fabrication."},
    {term:"Goulot d'étranglement",def:"Point de la production qui limite le débit global ; à éviter par la réduction des lots."},
    {term:"Temps d'adaptation",def:"Temps de réglage des machines entre deux productions ; à réduire pour optimiser."},
    {term:"Capacité de livraison",def:"Aptitude à livrer immédiatement à partir du stock disponible."}
  ]}],
 questions:[
  {q:"Que désigne la PCP ?",options:["Prix Coût Production","Planification et Contrôle de la Production","Préparation Commande Palette","Plan Comptable Public"],answer:1},
  {q:"Que planifie et contrôle la PCP ?",options:["Uniquement les prix","La production en quantités et délais","Le marketing","Les salaires"],answer:1},
  {q:"Quelles sont des tâches de la PCP ? (plusieurs réponses)",options:["Planification du travail et des durées","Gestion des marchandises","Détermination du type de fabrication","Recrutement du personnel"],answers:[0,1,2],multi:true},
  {q:"Quel facteur est essentiel pour la planification ?",options:["La couleur des produits","La durée de fabrication","Le nom du fournisseur","La taille du bureau"],answer:1},
  {q:"Comment optimiser les processus ? (plusieurs réponses)",options:["Utiliser un système PCP","Réduire la taille des lots","Réduire le temps d'adaptation des machines","Allonger les durées de stockage"],answers:[0,1,2],multi:true},
  {q:"Réduire la taille des lots permet d'éviter :",options:["La qualité","Un goulot d'étranglement","Les ventes","La livraison"],answer:1},
  {q:"Pourquoi des stocks sont-ils nécessaires ? (plusieurs réponses)",options:["Maintenir la capacité de livraison","Compenser les délais de réapprovisionnement","Absorber les fluctuations de la demande","Augmenter les coûts"],answers:[0,1,2],multi:true},
  {q:"La PCP concerne aussi :",options:["Uniquement la production","L'approvisionnement et la distribution","Le marketing seul","La comptabilité seule"],answer:1}
 ]};

const CHE13 = {id:"ce13",num:13,mod:"E",title:"Les nomenclatures",icon:"📑",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"Une nomenclature est une liste qui détaille tous les objets nécessaires pour fabriquer un produit. En logistique, elle joue un rôle essentiel dans la gestion des données de production."},
  {T:"section",x:"Les types de nomenclatures"},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Trois types",x:"• Quantitative : indique uniquement les quantités et références (ex. 8 roues, 4 fenêtres, 10 pièces 2×4)\n• Structurelle : montre comment les pièces s'assemblent (roues → boogies → wagon → toit)\n• Des kits : regroupe des pièces déjà assemblées comme une unité (boogie préassemblé)"},
  {T:"section",x:"L'utilité des nomenclatures"},
  {T:"list",items:["Planifier les besoins en matériaux","Contrôler les coûts de production grâce aux prix unitaires","Organiser efficacement les étapes de fabrication","Garantir une production fluide et éviter les erreurs"]},
  {T:"gloss",items:[
    {term:"Nomenclature",def:"Liste détaillant tous les objets nécessaires pour fabriquer un produit."},
    {term:"Nomenclature quantitative",def:"Indique uniquement les quantités et références des pièces nécessaires."},
    {term:"Nomenclature structurelle",def:"Montre comment les pièces et assemblages se combinent pour former le produit."},
    {term:"Nomenclature des kits",def:"Regroupe des pièces déjà assemblées considérées comme une unité."},
    {term:"Prix unitaire",def:"Coût d'une pièce, utilisé via la nomenclature pour contrôler les coûts de production."}
  ]}],
 questions:[
  {q:"Qu'est-ce qu'une nomenclature ?",options:["Une liste de clients","Une liste des objets nécessaires pour fabriquer un produit","Un planning de livraison","Un catalogue de prix de vente"],answer:1},
  {q:"La nomenclature quantitative indique :",options:["L'assemblage des pièces","Uniquement les quantités et références","Les kits préassemblés","Les clients"],answer:1},
  {q:"La nomenclature structurelle montre :",options:["Les quantités seules","Comment les pièces s'assemblent","Les prix de vente","Les fournisseurs"],answer:1},
  {q:"La nomenclature des kits regroupe :",options:["Des pièces déjà assemblées comme une unité","Uniquement des vis","Les clients","Les délais"],answer:0},
  {q:"À quoi servent les nomenclatures ? (plusieurs réponses)",options:["Planifier les besoins en matériaux","Contrôler les coûts de production","Organiser les étapes de fabrication","Recruter du personnel"],answers:[0,1,2],multi:true},
  {q:"« 8 roues, 4 fenêtres, 10 pièces 2×4 » est un exemple de nomenclature :",options:["Structurelle","Quantitative","Des kits","Commerciale"],answer:1},
  {q:"Les nomenclatures permettent d'éviter :",options:["Les ventes","Les erreurs de production","Les bénéfices","Les clients"],answer:1},
  {q:"Un boogie préassemblé relève de la nomenclature :",options:["Quantitative","Structurelle","Des kits","Commerciale"],answer:2}
 ]};

const CHE14 = {id:"ce14",num:14,mod:"E",title:"La production et le stockage",icon:"📦",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"La production est étroitement liée à la logistique et au stockage. Pour garantir le bon déroulement, les logisticiens doivent livrer les bons matériaux au bon moment aux lieux de production et récupérer les produits finis."},
  {T:"section",x:"Les stocks de production"},
  {T:"hl",bg:"#ede7f6",b:"#6A1B9A",ti:"Les types de stocks de production",x:"• Stock en amont : alimente la production en matières premières et consommables\n• Stock intermédiaire (tampon) : recueille provisoirement les biens entre étapes, là où la production n'est pas régulière\n• Stock en aval : produits finis ou semi-finis, compense les fluctuations production/vente (stockage court)"},
  {T:"section",x:"Le stock de proximité"},
  {T:"text",x:"Un stock de proximité est un petit stock dans lequel on entrepose du petit matériel utilisé fréquemment ou de petites pièces de rechange. Les articles peuvent être prélevés de façon informelle, sans bordereau de prélèvement."},
  {T:"gloss",items:[
    {term:"Stock de production en amont",def:"Alimente la production en matières premières et consommables pour maintenir le fonctionnement."},
    {term:"Stock intermédiaire (tampon)",def:"Recueille provisoirement les biens entre étapes de production irrégulières."},
    {term:"Stock de production en aval",def:"Contient produits finis/semi-finis ; compense les fluctuations production/vente."},
    {term:"Stock de proximité",def:"Petit stock de matériel fréquent, prélevable sans bordereau."},
    {term:"Stock tampon",def:"Autre nom du stock intermédiaire, absorbant les irrégularités du flux."}
  ]}],
 questions:[
  {q:"Quel stock alimente la production en matières premières ?",options:["Le stock en aval","Le stock en amont","Le stock de proximité","Le stock bloqué"],answer:1},
  {q:"Quel est l'autre nom du stock intermédiaire ?",options:["Stock tampon","Stock final","Stock mort","Stock de sécurité"],answer:0},
  {q:"Le stock de production en aval contient :",options:["Des matières premières","Des produits finis ou semi-finis","Des déchets","Des outils"],answer:1},
  {q:"Le stock de proximité permet un prélèvement :",options:["Avec bordereau obligatoire","Informel, sans bordereau","Interdit aux logisticiens","Une fois par mois"],answer:1},
  {q:"Quels sont les types de stocks de production ? (plusieurs réponses)",options:["En amont","Intermédiaire (tampon)","En aval","De distribution finale"],answers:[0,1,2],multi:true},
  {q:"Le stock intermédiaire est nécessaire quand :",options:["La production est parfaitement régulière","La production n'est pas régulière","Il n'y a pas de production","Le stock est vide"],answer:1},
  {q:"Que contient un stock de proximité ?",options:["De grandes palettes","Du petit matériel fréquent et pièces de rechange","Des produits dangereux","Des archives"],answer:1},
  {q:"Le stock en aval compense :",options:["Les pannes machines","Les fluctuations entre production et vente","Les retards de paie","Les absences"],answer:1}
 ]};

const CHE15 = {id:"ce15",num:15,mod:"E",title:"La qualité de la production",icon:"✅",color:"#6A1B9A",textColor:"#fff",
 content:[
  {T:"intro",x:"Plusieurs facteurs influent sur la qualité de la production : facteurs environnementaux, transport, contrôle, transformation et préparation, traçabilité."},
  {T:"section",x:"Le concept HACCP"},
  {T:"hl",bg:"#fef2f2",b:"#C62828",ti:"HACCP",x:"« Hazard Analysis and Critical Control Point Concept » (analyse des dangers – points critiques pour leur maîtrise) : système préventif garantissant la sécurité des denrées alimentaires et des consommateurs. Appliqué par les entreprises qui produisent, traitent et distribuent des denrées alimentaires et biens de consommation courante."},
  {T:"section",x:"Les instructions de procédure (IP)"},
  {T:"text",x:"Les instructions de procédure (IP) contiennent les règles fondamentales répondant aux questions : quand, dans quelle situation, par qui et de quelle manière il faut agir."},
  {T:"section",x:"Les facteurs influant sur la qualité"},
  {T:"list",items:["Facteurs environnementaux","Transport","Contrôle","Transformation et préparation","Traçabilité"]},
  {T:"gloss",items:[
    {term:"HACCP",def:"Hazard Analysis and Critical Control Point : système préventif garantissant la sécurité des denrées alimentaires."},
    {term:"Point critique",def:"Étape du processus où un danger doit être maîtrisé pour garantir la sécurité."},
    {term:"Instruction de procédure (IP)",def:"Règle fondamentale précisant quand, par qui et comment agir."},
    {term:"Traçabilité",def:"Capacité de suivre un produit à toutes les étapes de sa production et distribution."},
    {term:"Assurance qualité",def:"Ensemble des mesures garantissant une qualité constante des produits ou prestations."}
  ]}],
 questions:[
  {q:"Que signifie HACCP ?",options:["High Analysis Critical Control Process","Hazard Analysis and Critical Control Point","Health And Clean Control Plan","Hazard And Climate Control Point"],answer:1},
  {q:"Quel est l'objectif du concept HACCP ?",options:["Augmenter les ventes","Garantir la sécurité des denrées alimentaires","Réduire les prix","Accélérer la production"],answer:1},
  {q:"Qui applique le concept HACCP ?",options:["Toutes les entreprises","Celles qui produisent, traitent et distribuent des denrées alimentaires","Les banques","Les transporteurs uniquement"],answer:1},
  {q:"Que contiennent les instructions de procédure (IP) ?",options:["Les prix de vente","Les règles : quand, par qui et comment agir","Les noms des clients","Les horaires d'ouverture"],answer:1},
  {q:"Quels facteurs influent sur la qualité de production ? (plusieurs réponses)",options:["Facteurs environnementaux","Transport","Traçabilité","Couleur du logo"],answers:[0,1,2],multi:true},
  {q:"La traçabilité permet de :",options:["Vendre plus cher","Suivre un produit à toutes les étapes","Réduire les stocks","Éviter les contrôles"],answer:1},
  {q:"Un point critique dans HACCP est :",options:["Une étape où un danger doit être maîtrisé","Un prix élevé","Un client mécontent","Une machine en panne"],answer:0},
  {q:"L'assurance qualité vise :",options:["Une qualité constante des produits/prestations","Des prix bas uniquement","Une production rapide","Moins de personnel"],answer:0}
 ]};
...
const MODULE_E_RAND_POOL = [
  ...
  ...CHE7.questions.map(q=>({...q,_ch:"CHE7",_chTitle:"La vente",_chColor:CHE7.color,_chTextColor:CHE7.textColor})),
  ...CHE8.questions.map(q=>({...q,_ch:"CHE8",_chTitle:"Prospection et étude de marché",_chColor:CHE8.color,_chTextColor:CHE8.textColor})),
  ...CHE9.questions.map(q=>({...q,_ch:"CHE9",_chTitle:"Que signifie produire",_chColor:CHE9.color,_chTextColor:CHE9.textColor})),
  ...CHE10.questions.map(q=>({...q,_ch:"CHE10",_chTitle:"Logistique de production",_chColor:CHE10.color,_chTextColor:CHE10.textColor})),
  ...CHE11.questions.map(q=>({...q,_ch:"CHE11",_chTitle:"Les flux de matériel",_chColor:CHE11.color,_chTextColor:CHE11.textColor})),
  ...CHE12.questions.map(q=>({...q,_ch:"CHE12",_chTitle:"Planification et contrôle (PCP)",_chColor:CHE12.color,_chTextColor:CHE12.textColor})),
  ...CHE13.questions.map(q=>({...q,_ch:"CHE13",_chTitle:"Les nomenclatures",_chColor:CHE13.color,_chTextColor:CHE13.textColor})),
  ...CHE14.questions.map(q=>({...q,_ch:"CHE14",_chTitle:"Production et stockage",_chColor:CHE14.color,_chTextColor:CHE14.textColor})),
  ...CHE15.questions.map(q=>({...q,_ch:"CHE15",_chTitle:"Qualité de la production",_chColor:CHE15.color,_chTextColor:CHE15.textColor})),
];

const MODULE_E = [CHE1,CHE2,CHE3,CHE4,CHE5,CHE6,CHE7,CHE8,CHE9,CHE10,CHE11,CHE12,CHE13,CHE14,CHE15];
  ...
  return (
    <div style={{maxWidth:780,margin:"0 auto",padding:"14px"}}>
      <div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"12px",flexWrap:"wrap"}}>
        <div>
          <div style={{fontSize:"13px",fontFamily:"monospace",color:"#9ca3af",fontWeight:"700"}}>CHAPITRE {ch.num} / {MODULE_REGISTRY[ch.mod]?.chapters.length||14}</div>
...
export default function App() {
  ...
  // ── NAVIGATION — hash = source de vérité, tick = force re-render ────────────
  function readNav() {
    ...
    if (h.startsWith("ch-")) {
      const p = h.split("-");
      return {mod:p[1], ch:p[2], tab:p[3]||"content", rand:false};
    }
  ...
  const go = (hash) => { window.location.hash = hash; forceUpdate(); };

  const goHome    = ()         => { if(!window.location.hash||window.location.hash==="#home")return; go("home"); };
  ...
  const {mod:activeModule, ch:activeChapterId, tab:activeTab, rand:showRandom} = readNav();
