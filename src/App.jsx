...
import { IMGS, IMGS_C } from "./imagesData.js";
...
const CH1 = {id:"c1",num:1,title:"Les systèmes de distribution",icon:"🚚",color:"#1565C0",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c2.src,alt:IMGS_C.c2.alt},
  ...
  {T:"img",src:IMGS_C.c3.src,alt:IMGS_C.c3.alt},
  ...
  {T:"img",src:IMGS_C.c4.src,alt:IMGS_C.c4.alt},
  ...
  {T:"img",src:IMGS_C.c5.src,alt:IMGS_C.c5.alt},
  {T:"img",src:IMGS_C.c6.src,alt:IMGS_C.c6.alt},
  ...
  {T:"img",src:IMGS_C.c7.src,alt:IMGS_C.c7.alt},
  ...
  {T:"img",src:IMGS_C.c8.src,alt:IMGS_C.c8.alt},
...
const CH2 = {id:"c2",num:2,title:"Le marché des services de distribution",icon:"🏢",color:"#00695C",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c9.src,alt:IMGS_C.c9.alt},
  ...
  {T:"img",src:IMGS_C.c11.src,alt:IMGS_C.c11.alt},
  ...
  {T:"img",src:IMGS_C.c10.src,alt:IMGS_C.c10.alt},
...
const CH3 = {id:"c3",num:3,title:"Les emballages",icon:"📦",color:"#E65100",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c12.src,alt:IMGS_C.c12.alt},
  {T:"img",src:IMGS_C.c13.src,alt:IMGS_C.c13.alt},
  ...
  {T:"img",src:IMGS_C.c14.src,alt:IMGS_C.c14.alt},
...
const CH4 = {id:"c4",num:4,title:"Les normes d'emballages",icon:"📐",color:"#4527A0",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c16.src,alt:IMGS_C.c16.alt},
  ...
  {T:"img",src:IMGS_C.c15.src,alt:IMGS_C.c15.alt},
...
const CH5 = {id:"c5",num:5,title:"Le marquage des emballages",icon:"🏷️",color:"#283593",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c17.src,alt:IMGS_C.c17.alt},
  ...
  {T:"img",src:IMGS_C.c18.src,alt:IMGS_C.c18.alt},
...
const CH7 = {id:"c7",num:7,title:"L'adressage",icon:"📍",color:"#558B2F",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c19.src,alt:IMGS_C.c19.alt},
  ...
  {T:"img",src:IMGS_C.c20.src,alt:IMGS_C.c20.alt},
...
const CH10 = {id:"c10",num:10,title:"Les modes de transport",icon:"🚛",color:"#37474F",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c21.src,alt:IMGS_C.c21.alt},
  ...
  {T:"img",src:IMGS_C.c22.src,alt:IMGS_C.c22.alt},
...
const CH12 = {id:"c12",num:12,title:"Le chargement de marchandises",icon:"⚖️",color:"#1B5E20",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS_C.c24.src,alt:IMGS_C.c24.alt},
...
const CHA4 = {id:"ca4",num:4,mod:"A",title:"Documents d'accompagnement des marchandises",icon:"📄",color:"#6A1B9A",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modA_img1.src,alt:IMGS.modA_img1.alt},
  ...
  {T:"img",src:IMGS.modA_img2.src,alt:IMGS.modA_img2.alt},
...
const CHA6 = {id:"ca6",num:6,mod:"A",title:"Le contrôle des quantités",icon:"⚖️",color:"#E65100",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modA_img12.src,alt:IMGS.modA_img12.alt},
  ...
  {T:"img",src:IMGS.modA_img9.src,alt:IMGS.modA_img9.alt},
  ...
  {T:"img",src:IMGS.modA_img11.src,alt:IMGS.modA_img11.alt},
...
const CHB1 = {id:"cb1",num:1,mod:"B",title:"Caractéristiques des marchandises à stocker",icon:"📊",color:"#1B5E20",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modB_img7.src,alt:IMGS.modB_img7.alt},
  ...
  {T:"img",src:IMGS.modB_img10.src,alt:IMGS.modB_img10.alt},
...
const CHB4 = {id:"cb4",num:4,mod:"B",title:"Les formes de stockage",icon:"📦",color:"#37474F",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modB_img14.src,alt:IMGS.modB_img14.alt},
...
const CHB6 = {id:"cb6",num:6,mod:"B",title:"Systèmes de rayonnages et adressage",icon:"🗂️",color:"#0277BD",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modB_img30.src,alt:IMGS.modB_img30.alt},
...
const CHD3 = {id:"cd3",num:3,mod:"D",title:"La sécurité au travail en entreprise",icon:"🏗️",color:"#37474F",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modD_img3.src,alt:IMGS.modD_img3.alt},
...
const CHD4 = {id:"cd4",num:4,mod:"D",title:"La prévention contre les incendies",icon:"🔥",color:"#BF360C",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modD_img7.src,alt:IMGS.modD_img7.alt},
...
const CHD6 = {id:"cd6",num:6,mod:"D",title:"Les substances dangereuses et l'environnement",icon:"☢️",color:"#2E7D32",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modD_img16.src,alt:IMGS.modD_img16.alt},
...
const CHE3 = {id:"ce3",num:3,mod:"E",title:"Les contrôles de la qualité",icon:"✅",color:"#2E7D32",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modE_img4.src,alt:IMGS.modE_img4.alt},
...
const CHE5 = {id:"ce5",num:5,mod:"E",title:"La communication",icon:"💬",color:"#37474F",textColor:"#fff",
 content:[
  ...
  {T:"img",src:IMGS.modE_img7.src,alt:IMGS.modE_img7.alt},
  {T:"img",src:IMGS.modE_img8.src,alt:IMGS.modE_img8.alt},
...
function ChapterView({ chapter, modMeta, scores, onSaveScore }) {
  const ch = chapter;
  ...
  const handleTabQCM = () => { if (view==="quiz") return; if (quizPaused) { setQuizPaused(false); setView("quiz"); } else startQuiz(); };
    ...
    return (
      <div>
        ...
        <div style={{display:"flex",alignItems:"center",gap:"6px",marginBottom:"10px"}}>
          <ProgressBar value={currentQ} max={ch.questions.length} color={ch.color}/><span style={{fontSize:"14px",color:ch.color,fontWeight:"700",minWidth:"36px"}}>{Math.round(currentQ/ch.questions.length*100)}%</span>
        </div>
  ...
  return (
    <div style={{maxWidth:780,margin:"0 auto",padding:"14px"}}>
      ...
      <div style={{display:"flex",gap:"7px",marginBottom:"14px"}}>
        <button onClick={handleTabCours} style={{padding:"9px 16px",borderRadius:"7px",border:"none",background:view==="content"?ch.color:"#f3f4f6",color:view==="content"?ch.textColor:"#374151",fontWeight:"700",cursor:"pointer",fontSize:"15px"}}>📖 Cours</button>
        <button onClick={handleTabGloss} style={{padding:"9px 16px",borderRadius:"7px",border:"none",background:view==="glossaire"?"#0369a1":"#f3f4f6",color:view==="glossaire"?"#fff":"#374151",fontWeight:"700",cursor:"pointer",fontSize:"15px"}}>📚 Glossaire</button>
        <button onClick={handleTabQCM} style={{padding:"9px 16px",borderRadius:"7px",border:"none",background:view==="quiz"?"#7c3aed":"#f3f4f6",color:view==="quiz"?"#fff":"#374151",fontWeight:"700",cursor:view==="quiz"?"default":"pointer",fontSize:"15px"}}>
      ...
      {view==="content"&&(
        <div style={{background:"#fff",borderRadius:"12px",padding:"16px",border:"1px solid #e5e7eb"}}>
          ...
          <div style={{borderTop:"1px solid #e5e7eb",marginTop:"16px",paddingTop:"14px",display:"flex",gap:"8px",flexWrap:"wrap"}}>
            <button onClick={handleTabGloss} style={{flex:1,padding:"9px",borderRadius:"8px",border:"1px solid #7dd3fc",background:"#f0f9ff",color:"#0369a1",fontWeight:"700",cursor:"pointer",fontSize:"15px"}}>📚 Glossaire</button>
            {quizPaused?<button onClick={()=>{setQuizPaused(false);setView("quiz");}} style={{flex:2,padding:"9px",borderRadius:"8px",border:"none",background:"#7c3aed",color:"#fff",fontWeight:"800",cursor:"pointer",fontSize:"12px"}}>▶ Reprendre le QCM</button>
            :<button onClick={startQuiz} style={{flex:2,padding:"9px",borderRadius:"8px",border:"none",background:ch.color,color:ch.textColor,fontWeight:"800",cursor:"pointer",fontSize:"12px"}}>Je suis prêt · QCM ({ch.questions.length} Q) →</button>}
          </div>
        </div>)}
      ...
      {view==="glossaire"&&(
        <div style={{background:"#fff",borderRadius:"12px",padding:"16px",border:"1px solid #e5e7eb"}}>
          ...
          <div style={{borderTop:"1px solid #e5e7eb",marginTop:"13px",paddingTop:"12px",display:"flex",gap:"8px"}}>
            <button onClick={handleTabCours} style={{flex:1,padding:"9px",borderRadius:"8px",border:`2px solid ${ch.color}`,background:"#fff",color:"#111",fontWeight:"700",cursor:"pointer",fontSize:"15px"}}>📖 Cours</button>
            {quizPaused?<button onClick={()=>{setQuizPaused(false);setView("quiz");}} style={{flex:2,padding:"9px",borderRadius:"8px",border:"none",background:"#7c3aed",color:"#fff",fontWeight:"800",cursor:"pointer",fontSize:"12px"}}>▶ Reprendre le QCM</button>
            :<button onClick={startQuiz} style={{flex:2,padding:"9px",borderRadius:"8px",border:"none",background:ch.color,color:ch.textColor,fontWeight:"800",cursor:"pointer",fontSize:"12px"}}>Je suis prêt · QCM ({ch.questions.length} Q) →</button>}
          </div>
        </div>)}
...
function QCMAleatoire({ modKey, randPool, randNb, randScores, onSaveScore }) {
  const meta = MODULE_REGISTRY[modKey].meta;
  const [questions] = useState(()=>shuffle(randPool).slice(0,randNb));
  const [currentQ, setCurrentQ] = useState(0);
  const [answers, setAnswers] = useState([]);
  const [selected, setSelected] = useState(null);
  const [multiSel, setMultiSel] = useState([]);
  ...
  if(done){const pct=Math.round(score/randNb*100);return(
    <div style={{maxWidth:780,margin:"0 auto",padding:"14px"}}>
      <div style={{background:pct>=70?"linear-gradient(135deg,#166534,#15803d)":"linear-gradient(135deg,#991b1b,#b91c1c)",color:"#fff",borderRadius:"16px",padding:"26px",textAlign:"center",marginBottom:"16px"}}>
        ...
        <div style={{fontSize:"11px",opacity:.8,marginBottom:"4px"}}>QCM Aléatoire {meta.title} — {randNb} questions</div>
        <div style={{fontSize:"42px",fontWeight:"900",lineHeight:1}}>{score}/{randNb}</div>
      ...
      {randScores.length>0&&<div style={{background:"#f8fafc",borderRadius:"8px",padding:"10px",marginBottom:"12px",fontSize:"14px",color:"#6b7280"}}>Meilleur score : <strong>{Math.max(...randScores)}/{randNb} ({Math.round(Math.max(...randScores)/randNb*100)}%)</strong></div>}
    </div>);}
    ...
    <div style={{maxWidth:780,margin:"0 auto",padding:"14px"}}>
      <div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"12px",flexWrap:"wrap"}}>
        <div>
          ...
          <h2 style={{margin:0,fontSize:"15px",fontWeight:"800"}}>🎲 {randNb} questions</h2>
        </div>
        {randScores.length>0&&<span style={{marginLeft:"auto",background:"#7c3aed",color:"#fff",borderRadius:"20px",padding:"3px 10px",fontSize:"11px",fontWeight:"700"}}>Meilleur : {Math.max(...randScores)}/{randNb}</span>}
      </div>
      <div style={{display:"flex",justifyContent:"space-between",fontSize:"14px",color:"#6b7280",marginBottom:"5px"}}><span>Q {currentQ+1} / {randNb}</span><span style={{display:"flex",alignItems:"center",gap:"6px"}}>{isM&&<span style={{background:"#7c3aed",color:"#fff",borderRadius:"20px",padding:"3px 11px",fontSize:"13px",fontWeight:"700"}}>✓ Multi</span>}<span>{score} pts</span></span></div>
      <div style={{display:"flex",alignItems:"center",gap:"6px",marginBottom:"8px"}}><ProgressBar value={currentQ} max={randNb} color="#7c3aed"/><span style={{fontSize:"14px",color:"#7c3aed",fontWeight:"700",minWidth:"36px"}}>{Math.round(currentQ/randNb*100)}%</span></div>
      ...
      <div style={{background:`linear-gradient(135deg,${meta.color},${meta.color}cc)`,borderRadius:"14px",padding:"18px 22px",marginBottom:"16px",color:"#fff",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative"}}>
          ...
          <button onClick={onStartRandom} style={{background:"#7c3aed",color:"#fff",border:"none",borderRadius:"10px",padding:"13px 24px",fontWeight:"800",fontSize:"16px",cursor:"pointer",display:"flex",alignItems:"center",gap:"8px"}}>
            ...
            QCM Aléatoire — {randNb} questions
...
export default function App() {
  ...
  // Parse state from hash: #home | #mod-A | #ch-A-ca1 | #rand-A
  function parseHash(hash) {
    const h = (hash||"").replace("#","");
    if (!h || h==="home") return {activeModule:null,activeChapter:null,showRandom:false};
    if (h.startsWith("mod-")) return {activeModule:h.slice(4),activeChapter:null,showRandom:false};
    if (h.startsWith("ch-")) { const [,mod,ch]=h.split("-"); return {activeModule:mod,activeChapter:ch,showRandom:false}; }
    if (h.startsWith("rand-")) return {activeModule:h.slice(5),activeChapter:null,showRandom:true};
    return {activeModule:null,activeChapter:null,showRandom:false};
  }

  const [navState, setNavState] = useState(()=>parseHash(window.location.hash));
  const {activeModule, activeChapter, showRandom} = navState;

  // Listen to browser back/forward
  useEffect(()=>{
    const onPop = ()=>setNavState(parseHash(window.location.hash));
  ...
  const goHome   = () => navigate("home", {activeModule:null,activeChapter:null,showRandom:false});
  const goModule = (k) => navigate(`mod-${k}`, {activeModule:k,activeChapter:null,showRandom:false});
  const goChapter = (modKey, chId) => navigate(`ch-${modKey}-${chId}`, {activeModule:modKey,activeChapter:chId,showRandom:false});
  const goRandom  = (modKey) => navigate(`rand-${modKey}`, {activeModule:modKey,activeChapter:null,showRandom:true});
  ...
  const saveChScore = (modKey, chId, sc) => setAllScores(p=>({...p,[modKey]:{...p[modKey],[chId]:sc}}));
  const saveRandScore = (modKey, sc) => setAllRandScores(p=>({...p,[modKey]:[...(p[modKey]||[]),sc]}));
  const resetAll = () => { setAllScores({A:{},B:{},C:{},D:{},E:{}}); setAllRandScores({A:[],B:[],C:[],D:[],E:[]}); };
  const resetChapter = (modKey, chId) => setAllScores(p=>{ const n={...p,[modKey]:{...p[modKey]}}; delete n[modKey][chId]; return n; });
  const resetRand = (modKey) => setAllRandScores(p=>({...p,[modKey]:[]}));

  const currentChapter = activeChapter ? MODULE_REGISTRY[activeModule]?.chapters.find(c=>c.id===activeChapter) : null;
  ...
  return(
    <div style={{minHeight:"100vh",background:"linear-gradient(160deg,#f8fafc 0%,#eff6ff 100%)",fontFamily:"'Segoe UI',system-ui,sans-serif"}}>
      ...
      {activeModule&&!activeChapter&&!showRandom&&<ModuleDashboard modKey={activeModule} scores={allScores[activeModule]||{}} randScores={allRandScores[activeModule]||[]} onSelectChapter={id=>goChapter(activeModule,id)} onStartRandom={()=>goRandom(activeModule)}/>}
      {activeModule&&activeChapter&&currentChapter&&<ChapterView chapter={currentChapter} modMeta={MODULE_REGISTRY[activeModule].meta} scores={allScores[activeModule]||{}} onSaveScore={(chId,sc)=>saveChScore(activeModule,chId,sc)}/>}
      {activeModule&&showRandom&&<QCMAleatoire modKey={activeModule} randPool={MODULE_REGISTRY[activeModule].randPool} randNb={MODULE_REGISTRY[activeModule].randNb} randScores={allRandScores[activeModule]||[]} onSaveScore={(sc)=>saveRandScore(activeModule,sc)}/>}
